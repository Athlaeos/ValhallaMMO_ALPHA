...
public class DynamicItemModifierManager {
    ...
    public DynamicItemModifierManager(){
        ...
        // SMITHING
        register(new DynamicDurabilityModifier("dynamic_durability", 0D, 0D, ModifierPriority.NEUTRAL));
        register(new DynamicBowStrengthModifier("dynamic_bow_strength", 0D, 0D, ModifierPriority.NEUTRAL));
        register(new DynamicDamageModifier("dynamic_damage", 0D, 0D, ModifierPriority.NEUTRAL));
        register(new DynamicAttackSpeedModifier("dynamic_attack_speed", 0D, 0D, ModifierPriority.NEUTRAL));
        register(new DynamicArmorModifier("dynamic_armor", 0D, 0D, ModifierPriority.NEUTRAL));
        register(new DynamicArmorToughnessModifier("dynamic_armor_toughness", 0D, 0D, ModifierPriority.NEUTRAL));
        register(new DynamicKnockbackResistanceModifier("dynamic_knockback_resistance", 0D, 0D, ModifierPriority.NEUTRAL));
        register(new DynamicMovementSpeedModifier("dynamic_movement_speed", 0D, 0D, ModifierPriority.NEUTRAL));
//        register(new DynamicKnockbackModifier("dynamic_knockback", 0D, ModifierPriority.NEUTRAL));
        register(new DynamicHealthBoostModifier("dynamic_health_boost", 0D, 0D, ModifierPriority.NEUTRAL));
        ...
        register(new DynamicAmountModifier("dynamic_amount", 0D, 0D, ModifierPriority.NEUTRAL));
        ...
        register(new MaterialTypeChangeModifier("material_type_set", 0D, ModifierPriority.NEUTRAL));
        register(new EquipmentTypeChangeModifier("equipment_type_set", 0D, ModifierPriority.NEUTRAL));
        register(new ChangeItemToDictionaryItemModifier("change_item", 0D, ModifierPriority.NEUTRAL));
        register(new ChangeItemNameToDictionaryItemNameModifier("change_item_name", 0D, ModifierPriority.NEUTRAL));
        register(new ChangeItemTypeToDictionaryItemTypeModifier("change_item_type", 0D, ModifierPriority.NEUTRAL));
        register(new ColorCodeItemLoreModifier("color_code_lore", 0D, ModifierPriority.NEUTRAL));
        register(new ColorCodeItemNameModifier("color_code_name", 0D, ModifierPriority.NEUTRAL));
        ...
        // ALCHEMY
        register(new DynamicPotionAmplifierModifier("potions_dynamic_amplifier", 0D, 0D, ModifierPriority.NEUTRAL));
        register(new DynamicPotionDurationModifier("potions_dynamic_duration", 0D, 0D, ModifierPriority.NEUTRAL));
...
//        register(new PotionEffectAddCustomModifier("potions_effect_add_weapons_damage", 0D, 0D, ModifierPriority.NEUTRAL, "WEAPONS_DAMAGE", Material.IRON_SWORD));
        ...
        register(new PotionEffectAddCustomModifier("potions_effect_add_damage_resistance", 0D, 0D, ModifierPriority.NEUTRAL, "CUSTOM_DAMAGE_RESISTANCE", Material.ENCHANTED_GOLDEN_APPLE));
        ...
        register(new PotionEffectAddCustomModifier("potions_effect_add_custom_fire_resistance", 0D, 0D, ModifierPriority.NEUTRAL, "CUSTOM_FIRE_RESISTANCE", Material.MAGMA_CREAM));
...
//        register(new CustomEnchantAddModifier("enchantment_add_unarmed_damage", Material.BLAZE_ROD, "UNARMED_DAMAGE", 0.1, 0.01, -1000, 1000));
        ...
        register(new CustomEnchantAddModifier("enchantment_add_health_multiplier", Material.ENCHANTED_GOLDEN_APPLE, "HEALTH_MULTIPLIER", 0.1, 0.01, -1000, 1000));
