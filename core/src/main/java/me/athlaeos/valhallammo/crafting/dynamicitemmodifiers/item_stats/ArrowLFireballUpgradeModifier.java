...
public class ArrowLFireballUpgradeModifier extends DuoArgDynamicItemModifier implements DynamicEditable {
    public ArrowLFireballUpgradeModifier(String name) {
        ...
        this.description = Utils.chat("&7Causes the arrow to be replaced by a large fireball projectile.");
        this.displayName = Utils.chat("&7&lSpecial Arrow: &6&lLarge Fireball");
