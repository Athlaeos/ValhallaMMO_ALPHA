...
public class AttributeAddArmorKBResistModifier extends DynamicItemModifier {
    ...
    public ItemStack processItem(Player crafter, ItemStack outputItem, int timesExecuted) {
        ...
        ItemAttributesManager.getInstance().addDefaultStat(outputItem, new VanillaKnockbackResistanceWrapper(strength, AttributeModifier.Operation.ADD_NUMBER, ItemUtils.getEquipmentSlot(outputItem)));
        return outputItem;
    }
