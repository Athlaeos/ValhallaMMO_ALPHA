...
public class AttributeAddArmorModifier extends DynamicItemModifier {
    public AttributeAddArmorModifier(String name) {
    ...
    public ItemStack processItem(Player crafter, ItemStack outputItem, int timesExecuted) {
        ...
        ItemAttributesManager.getInstance().addDefaultStat(outputItem, new VanillaArmorWrapper(strength, AttributeModifier.Operation.ADD_NUMBER, ItemUtils.getEquipmentSlot(outputItem)));
        return outputItem;
    }
