...
public class AttributeAddArmorToughnessModifier extends DynamicItemModifier {
    public AttributeAddArmorToughnessModifier(String name) {
    ...
    public ItemStack processItem(Player crafter, ItemStack outputItem, int timesExecuted) {
        ...
        ItemAttributesManager.getInstance().addDefaultStat(outputItem, new VanillaArmorToughnessWrapper(strength, AttributeModifier.Operation.ADD_NUMBER, ItemUtils.getEquipmentSlot(outputItem)));
        return outputItem;
    }
