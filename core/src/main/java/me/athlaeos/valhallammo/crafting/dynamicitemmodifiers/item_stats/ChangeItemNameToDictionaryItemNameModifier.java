...
public class ChangeItemNameToDictionaryItemNameModifier extends DynamicItemModifier implements Cloneable {

    public ChangeItemNameToDictionaryItemNameModifier(String name, double strength, ModifierPriority priority) {
