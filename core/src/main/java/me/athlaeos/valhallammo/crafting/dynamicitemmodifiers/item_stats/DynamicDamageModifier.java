...
public class DynamicDamageModifier extends DuoArgDynamicItemModifier {
    public DynamicDamageModifier(String name, double strength, double strength2, ModifierPriority priority) {
        ...
        this.description = Utils.chat("&7Updates the item's attack damage value if it has one. The strength of the modifier " +
                ...
                "is 0.8 for example, a base damage of 10 cannot be reduced to anything below 8 and will always be 8" +
    ...
    public ItemStack processItem(Player crafter, ItemStack outputItem) {
        ...
        SmithingItemTreatmentManager.getInstance().applyAttributeScaling(outputItem, finalQuality, "GENERIC_ATTACK_DAMAGE", strength2);
        return outputItem;
    }

    @Override
    public String toString() {
        return Utils.chat(String.format("&7Setting the item's attack damage to be &e%s%%&7 efficient with its quality score. " +
