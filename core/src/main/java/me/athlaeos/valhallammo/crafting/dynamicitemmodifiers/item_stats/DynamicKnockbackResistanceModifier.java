...
public class DynamicKnockbackResistanceModifier extends DuoArgDynamicItemModifier {
    public DynamicKnockbackResistanceModifier(String name, double strength, double strength2, ModifierPriority priority) {
        ...
        this.description = Utils.chat("&7Updates the item's knockback resistance if it has one. The strength of the modifier " +
                ...
                "is 0.8 for example, a base knockback resistance of 10% cannot be reduced to anything below 8% and will always be 8%" +
    ...
    public ItemStack processItem(Player crafter, ItemStack outputItem) {
        ...
        SmithingItemTreatmentManager.getInstance().applyAttributeScaling(outputItem, finalQuality, "GENERIC_KNOCKBACK_RESISTANCE", strength2);
        return outputItem;
    }
