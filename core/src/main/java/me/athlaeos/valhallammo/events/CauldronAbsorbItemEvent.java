...
public class CauldronAbsorbItemEvent extends BlockEvent implements Cancellable {
    ...
    private Item absorbedItem;

    public CauldronAbsorbItemEvent(@NotNull Block theBlock, Item absorbedItem, Player thrower) {
        super(theBlock);
    ...
    public void setAbsorbedItem(Item absorbedItem) {
        this.absorbedItem = absorbedItem;
    }
