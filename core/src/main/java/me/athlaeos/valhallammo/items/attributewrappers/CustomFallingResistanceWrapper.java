...
public class CustomFallingResistanceWrapper extends AttributeWrapper{
    private final String translation_explosion_resistance = Utils.chat(TranslationManager.getInstance().getTranslation("translation_falling_resistance"));

    public CustomFallingResistanceWrapper(double amount, AttributeModifier.Operation operation, EquipmentSlot slot) {
        super(amount, operation, slot);
        this.attribute = "CUSTOM_FALLING_RESISTANCE";
        this.minValue = -1000;
        this.maxValue = 1000;
    }
