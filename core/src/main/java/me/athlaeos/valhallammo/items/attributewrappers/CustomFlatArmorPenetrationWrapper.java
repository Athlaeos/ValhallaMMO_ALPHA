...
public class CustomFlatArmorPenetrationWrapper extends AttributeWrapper{
    private final String displayLore = Utils.chat(TranslationManager.getInstance().getTranslation("translation_armorpiercingflat"));

    public CustomFlatArmorPenetrationWrapper(double amount, AttributeModifier.Operation operation, EquipmentSlot slot) {
        super(amount, operation, slot);
        this.attribute = "CUSTOM_FLAT_ARMOR_PENETRATION";
