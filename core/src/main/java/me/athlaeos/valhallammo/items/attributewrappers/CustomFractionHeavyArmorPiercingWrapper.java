...
public class CustomFractionHeavyArmorPiercingWrapper extends AttributeWrapper{
    private final String displayLore = Utils.chat(TranslationManager.getInstance().getTranslation("translation_heavyarmorpiercingfraction"));

    public CustomFractionHeavyArmorPiercingWrapper(double amount, AttributeModifier.Operation operation, EquipmentSlot slot) {
        super(amount, operation, slot);
        this.attribute = "CUSTOM_FRACTION_HEAVY_ARMOR_PENETRATION";
