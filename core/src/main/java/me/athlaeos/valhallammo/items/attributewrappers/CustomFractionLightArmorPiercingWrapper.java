...
public class CustomFractionLightArmorPiercingWrapper extends AttributeWrapper{
    private final String displayLore = Utils.chat(TranslationManager.getInstance().getTranslation("translation_lightarmorpiercingfraction"));

    public CustomFractionLightArmorPiercingWrapper(double amount, AttributeModifier.Operation operation, EquipmentSlot slot) {
        super(amount, operation, slot);
        this.attribute = "CUSTOM_FRACTION_LIGHT_ARMOR_PENETRATION";
