...
public class CustomMeleeResistanceWrapper extends AttributeWrapper{
    private final String translation_projectile_resistance = Utils.chat(TranslationManager.getInstance().getTranslation("translation_melee_resistance"));

    public CustomMeleeResistanceWrapper(double amount, AttributeModifier.Operation operation, EquipmentSlot slot) {
        super(amount, operation, slot);
        this.attribute = "CUSTOM_MELEE_RESISTANCE";
        this.minValue = -1000;
        this.maxValue = 1000;
    }
