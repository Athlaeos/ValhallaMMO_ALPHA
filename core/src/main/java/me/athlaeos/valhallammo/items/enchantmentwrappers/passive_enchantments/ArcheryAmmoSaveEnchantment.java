...
public class ArcheryAmmoSaveEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_archery_ammo_save"));

    public ArcheryAmmoSaveEnchantment(double amount) {
        super(amount);
        this.attribute = "ARCHERY_AMMO_SAVE";
