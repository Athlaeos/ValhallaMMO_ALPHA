...
public class ArmorMultiplierEnchantment extends EnchantmentWrapper {
    private final String display = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_armormultiplierbonus"));

    public ArmorMultiplierEnchantment(double amount) {
        super(amount);
        this.attribute = "ARMOR_MULTIPLIER";
