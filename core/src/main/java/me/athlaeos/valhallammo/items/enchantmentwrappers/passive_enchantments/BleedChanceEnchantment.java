...
public class BleedChanceEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_bleed_chance"));

    public BleedChanceEnchantment(double amount) {
        super(amount);
        this.attribute = "BLEED_CHANCE";
