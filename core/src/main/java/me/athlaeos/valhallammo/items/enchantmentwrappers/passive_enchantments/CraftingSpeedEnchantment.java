...
public class CraftingSpeedEnchantment extends EnchantmentWrapper {
    private final String display = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_crafting_time_reduction"));

    public CraftingSpeedEnchantment(double amount) {
        super(amount);
        this.attribute = "CRAFTING_SPEED";
