...
public class CritDamageEnchantment extends EnchantmentWrapper {
    private final String translation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_crit_damage"));

    public CritDamageEnchantment(double amount) {
        super(amount);
        this.attribute = "CRIT_DAMAGE";
