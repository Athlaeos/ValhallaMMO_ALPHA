...
public class DamageResistanceEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_damage_resistance"));

    public DamageResistanceEnchantment(double amount) {
        super(amount);
        this.attribute = "DAMAGE_RESISTANCE";
