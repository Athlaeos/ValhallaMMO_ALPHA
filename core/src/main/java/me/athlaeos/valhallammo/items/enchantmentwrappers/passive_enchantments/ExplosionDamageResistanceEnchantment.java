...
public class ExplosionDamageResistanceEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_explosion_damage_resistance"));

    public ExplosionDamageResistanceEnchantment(double amount) {
        super(amount);
        this.attribute = "EXPLOSION_DAMAGE_RESISTANCE";
