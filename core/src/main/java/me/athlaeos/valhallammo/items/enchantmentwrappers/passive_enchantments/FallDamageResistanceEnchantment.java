...
public class FallDamageResistanceEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_fall_damage_resistance"));

    public FallDamageResistanceEnchantment(double amount) {
        super(amount);
        this.attribute = "FALL_DAMAGE_RESISTANCE";
