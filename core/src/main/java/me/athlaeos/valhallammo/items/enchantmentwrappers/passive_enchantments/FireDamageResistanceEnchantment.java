...
public class FireDamageResistanceEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_fire_damage_resistance"));

    public FireDamageResistanceEnchantment(double amount) {
        super(amount);
        this.attribute = "FIRE_DAMAGE_RESISTANCE";
