...
public class FlatArmorPenetrationEnchantment extends EnchantmentWrapper {
    private final String translation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_flat_armor_penetration"));

    public FlatArmorPenetrationEnchantment(double amount) {
        super(amount);
        this.attribute = "FLAT_ARMOR_PENETRATION";
