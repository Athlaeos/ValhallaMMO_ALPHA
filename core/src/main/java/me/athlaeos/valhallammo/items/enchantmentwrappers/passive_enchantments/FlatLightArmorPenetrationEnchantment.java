...
public class FlatLightArmorPenetrationEnchantment extends EnchantmentWrapper {
    private final String translation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_flat_light_armor_penetration"));

    public FlatLightArmorPenetrationEnchantment(double amount) {
        super(amount);
        this.attribute = "FLAT_LIGHT_ARMOR_PENETRATION";
