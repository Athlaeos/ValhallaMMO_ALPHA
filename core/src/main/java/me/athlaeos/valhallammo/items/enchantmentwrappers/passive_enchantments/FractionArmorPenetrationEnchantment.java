...
public class FractionArmorPenetrationEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_fraction_armor_penetration"));

    public FractionArmorPenetrationEnchantment(double amount) {
        super(amount);
