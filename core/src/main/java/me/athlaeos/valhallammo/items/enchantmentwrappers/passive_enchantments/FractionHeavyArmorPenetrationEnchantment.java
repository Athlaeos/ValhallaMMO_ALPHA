...
public class FractionHeavyArmorPenetrationEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_fraction_heavy_armor_penetration"));

    public FractionHeavyArmorPenetrationEnchantment(double amount) {
        super(amount);
        this.attribute = "FRACTION_HEAVY_ARMOR_PENETRATION";
