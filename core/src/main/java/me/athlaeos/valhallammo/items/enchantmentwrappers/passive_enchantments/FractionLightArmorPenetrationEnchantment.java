...
public class FractionLightArmorPenetrationEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_fraction_light_armor_penetration"));

    public FractionLightArmorPenetrationEnchantment(double amount) {
        super(amount);
        this.attribute = "FRACTION_LIGHT_ARMOR_PENETRATION";
