...
public class HealthMultiplierEnchantment extends EnchantmentWrapper {
    private final String display = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_healthmultiplierbonus"));

    public HealthMultiplierEnchantment(double amount) {
        super(amount);
        this.attribute = "HEALTH_MULTIPLIER";
