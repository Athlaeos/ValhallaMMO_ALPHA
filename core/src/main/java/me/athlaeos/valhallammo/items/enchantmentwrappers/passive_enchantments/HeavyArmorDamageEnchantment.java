...
public class HeavyArmorDamageEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_heavy_armor_damage"));

    public HeavyArmorDamageEnchantment(double amount) {
        super(amount);
        this.attribute = "HEAVY_ARMOR_DAMAGE";
