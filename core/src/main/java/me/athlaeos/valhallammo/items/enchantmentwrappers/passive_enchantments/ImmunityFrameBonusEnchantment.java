...
public class ImmunityFrameBonusEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_immunity_frame_bonus"));

    public ImmunityFrameBonusEnchantment(double amount) {
        super(amount);
        this.attribute = "IMMUNITY_FRAME_BONUS";
