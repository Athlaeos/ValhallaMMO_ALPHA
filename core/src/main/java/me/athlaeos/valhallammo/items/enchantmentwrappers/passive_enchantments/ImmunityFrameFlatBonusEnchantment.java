...
public class ImmunityFrameFlatBonusEnchantment extends EnchantmentWrapper {
    private final String translation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_immunity_frame_flat_bonus"));

    public ImmunityFrameFlatBonusEnchantment(double amount) {
        super(amount);
        this.attribute = "IMMUNITY_FRAME_FLAT_BONUS";
