...
public class ImmunityFrameReductionEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_immunity_frame_reduction"));

    public ImmunityFrameReductionEnchantment(double amount) {
        super(amount);
        this.attribute = "IMMUNITY_FRAME_REDUCTION";
