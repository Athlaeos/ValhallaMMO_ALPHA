...
public class LightArmorDamageEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_light_armor_damage"));

    public LightArmorDamageEnchantment(double amount) {
        super(amount);
        this.attribute = "LIGHT_ARMOR_DAMAGE";
