...
public class MagicDamageResistanceEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_magic_damage_resistance"));

    public MagicDamageResistanceEnchantment(double amount) {
        super(amount);
        this.attribute = "MAGIC_DAMAGE_RESISTANCE";
