...
public class MeleeDamageResistanceEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_melee_damage_resistance"));

    public MeleeDamageResistanceEnchantment(double amount) {
        super(amount);
        this.attribute = "MELEE_DAMAGE_RESISTANCE";
