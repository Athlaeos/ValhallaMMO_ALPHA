...
public class MiningExtraDropsEnchantment extends EnchantmentWrapper {
    private final String translation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_mining_extra_drops"));

    public MiningExtraDropsEnchantment(double amount) {
        super(amount);
        this.attribute = "MINING_EXTRA_DROPS";
        this.minValue = -1000;
        this.maxValue = 1000;
    }
