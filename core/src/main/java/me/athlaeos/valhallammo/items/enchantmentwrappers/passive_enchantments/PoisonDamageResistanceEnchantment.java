...
public class PoisonDamageResistanceEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_poison_damage_resistance"));

    public PoisonDamageResistanceEnchantment(double amount) {
        super(amount);
        this.attribute = "POISON_DAMAGE_RESISTANCE";
