...
public class ProjectileDamageResistanceEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_projectile_damage_resistance"));

    public ProjectileDamageResistanceEnchantment(double amount) {
        super(amount);
        this.attribute = "PROJECTILE_DAMAGE_RESISTANCE";
