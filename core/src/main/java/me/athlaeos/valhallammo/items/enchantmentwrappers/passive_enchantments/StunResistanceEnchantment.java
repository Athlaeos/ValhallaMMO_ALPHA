...
public class StunResistanceEnchantment extends EnchantmentWrapper {
    private final String display = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_stunresistance"));

    public StunResistanceEnchantment(double amount) {
        super(amount);
        this.attribute = "STUN_RESISTANCE";
