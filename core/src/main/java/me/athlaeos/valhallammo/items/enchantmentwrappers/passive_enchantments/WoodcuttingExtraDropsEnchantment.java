...
public class WoodcuttingExtraDropsEnchantment extends EnchantmentWrapper {
    private final String translation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_woodcutting_extra_drops"));

    public WoodcuttingExtraDropsEnchantment(double amount) {
        super(amount);
        this.attribute = "WOODCUTTING_EXTRA_DROPS";
        this.minValue = -1000;
        this.maxValue = 1000;
    }
