...
//        defaultVanillaPotionStats = new HashMap<>();
        ...
        registerPotionEffect(new CustomPotionEffectWrapper("FORTIFY_ANVIL_COMBINING", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_fortify_anvil_combining"), "+%.1f", false));
        ...
        registerPotionEffect(new CustomPotionEffectWrapper("DIGGING_EXTRA_DROPS", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_digging_extra_drops"), "+%.1f%%", false));
        registerPotionEffect(new CustomPotionEffectWrapper("DIGGING_RARE_DROPS", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_digging_rare_drops"), "+%.1f%%", false));
        ...
        registerPotionEffect(new CustomPotionEffectWrapper("WEAPONS_DAMAGE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_weapons_damage"), "+%.1f%%", false, 100));
        ...
        registerPotionEffect(new CustomPotionEffectWrapper("ARMOR_FLAT_BONUS", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_armor_flat_bonus"), "+%.1f", false));
        registerPotionEffect(new CustomPotionEffectWrapper("LIGHT_ARMOR_FLAT_BONUS", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_light_armor_flat_bonus"), "+%.1f", false));
        registerPotionEffect(new CustomPotionEffectWrapper("HEAVY_ARMOR_FLAT_BONUS", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_heavy_armor_flat_bonus"), "+%.1f", false));
        registerPotionEffect(new CustomPotionEffectWrapper("ARMOR_FRACTION_BONUS", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_armor_fraction_bonus"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("LIGHT_ARMOR_FRACTION_BONUS", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_light_armor_fraction_bonus"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("HEAVY_ARMOR_FRACTION_BONUS", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_heavy_armor_fraction_bonus"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("CUSTOM_DAMAGE_RESISTANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_custom_damage_resistance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("EXPLOSION_RESISTANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_explosion_resistance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("CUSTOM_FIRE_RESISTANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_custom_fire_resistance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("MAGIC_RESISTANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_magic_resistance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("POISON_RESISTANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_poison_resistance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("PROJECTILE_RESISTANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_projectile_resistance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("MELEE_RESISTANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_melee_resistance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("FALLING_RESISTANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_falling_resistance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("KNOCKBACK_RESISTANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_knockback_resistance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("BLEED_RESISTANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_bleed_resistance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("CRAFTING_TIME_REDUCTION", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_crafting_time_reduction"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("HUNGER_SAVE_CHANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_hunger_save_chance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("DODGE_CHANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_dodge_chance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("KNOCKBACK_BONUS", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_knockback_bonus"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("COOLDOWN_REDUCTION", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_cooldown_reduction"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("IMMUNITY_FRAME_BONUS", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_immunity_frame_bonus"), "+%.0f", false));
        registerPotionEffect(new CustomPotionEffectWrapper("IMMUNITY_FRAME_MULTIPLIER", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_immunity_frame_multiplier"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("HEALING_BONUS", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_healing_bonus"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("REFLECT_CHANCE", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_reflect_chance"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("REFLECT_FRACTION", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_reflect_fraction"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("FRACTION_ARMOR_REDUCTION", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_fraction_armor_reduction"), "+%.1f%%", false, 100));
        registerPotionEffect(new CustomPotionEffectWrapper("FLAT_ARMOR_REDUCTION", 0, 0, TranslationManager.getInstance().getTranslation("potion_effect_flat_armor_reduction"), "+%.1f", false));
    }
