...
import me.athlaeos.valhallammo.perkrewards.account.SkillExperienceAddReward;
import me.athlaeos.valhallammo.perkrewards.account.SkillLevelsAddReward;
...
public class SkillProgressionManager {
    ...
    public void registerSkill(Skill skill){
        PerkRewardsManager.getInstance().register(new SkillExperienceAddReward("skill_experience_add_" + skill.getType().toLowerCase(), skill));
        PerkRewardsManager.getInstance().register(new SkillLevelsAddReward("skill_levels_add_" + skill.getType().toLowerCase(), skill));
