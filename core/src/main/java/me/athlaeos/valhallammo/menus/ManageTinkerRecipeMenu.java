    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (e.getCurrentItem() != null){
            if (e.getCurrentItem().equals(returnToMenuButton)) {
                ...
                current_improvement_recipe.setUnlockedForEveryone(unlockedForEveryone);
...
//                    break;
    ...
    private void setCreateImproveRecipeView(){
        if (current_improvement_recipe != null){
            ...
            currentModifiers = new ArrayList<>(current_improvement_recipe.getItemModifiers());
            ...
            unlockedForEveryone = current_improvement_recipe.isUnlockedForEveryone();
