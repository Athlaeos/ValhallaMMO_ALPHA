...
public class ViewCauldronRecipeMenu extends Menu {
    ...
    public ViewCauldronRecipeMenu(PlayerMenuUtility playerMenuUtility) {
    ...
    public String getMenuName() {
        return Utils.chat("&7View Cauldron Recipes");
    }
    ...
    public boolean isRecipeUnlocked(Player player, DynamicCauldronRecipe recipe){
    ...
    private void setCustomRecipesView(){
        ...
        for (DynamicCauldronRecipe recipe : CustomRecipeManager.getInstance().getCauldronRecipes().values()){
            ...
            resultLore.add(Utils.chat("&fCatalyst: " + Utils.getItemName(recipe.isCatalystExactMeta() ? recipe.getCatalyst() : new ItemStack(recipe.getCatalyst().getType()))));
            resultLore.add(Utils.chat("&8&m                                      "));
