...
public class ViewCraftRecipeMenu extends Menu {
    ...
    public ViewCraftRecipeMenu(PlayerMenuUtility playerMenuUtility) {
    ...
    public String getMenuName() {
        return Utils.chat("&7View Craft Recipes");
    }
