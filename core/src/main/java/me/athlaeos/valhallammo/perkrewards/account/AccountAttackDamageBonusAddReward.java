...
public class AccountAttackDamageBonusAddReward extends PerkReward {
     ...
     */
    public AccountAttackDamageBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setAttackDamageBonus(accountProfile.getAttackDamageBonus() + bonus);
