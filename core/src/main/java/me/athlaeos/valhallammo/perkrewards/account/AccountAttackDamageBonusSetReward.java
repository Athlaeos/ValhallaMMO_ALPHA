...
public class AccountAttackDamageBonusSetReward extends PerkReward {
     ...
     */
    public AccountAttackDamageBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setAttackDamageBonus(bonus);
