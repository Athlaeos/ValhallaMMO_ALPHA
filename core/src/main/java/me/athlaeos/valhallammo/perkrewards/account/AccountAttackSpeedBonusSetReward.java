...
public class AccountAttackSpeedBonusSetReward extends PerkReward {
     ...
     */
    public AccountAttackSpeedBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setAttackSpeedBonus(bonus);
