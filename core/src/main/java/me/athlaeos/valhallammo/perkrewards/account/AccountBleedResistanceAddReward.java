...
public class AccountBleedResistanceAddReward extends PerkReward {
     ...
     */
    public AccountBleedResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setBleedResistance(accountProfile.getBleedResistance() + resistance);
