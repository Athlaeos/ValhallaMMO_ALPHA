...
public class AccountDamageResistanceAddReward extends PerkReward {
     ...
     */
    public AccountDamageResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setDamageResistance(accountProfile.getDamageResistance() + resistance);
