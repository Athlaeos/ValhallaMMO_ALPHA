...
public class AccountFireResistanceAddReward extends PerkReward {
     ...
     */
    public AccountFireResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setFireResistance(accountProfile.getFireResistance() + resistance);
