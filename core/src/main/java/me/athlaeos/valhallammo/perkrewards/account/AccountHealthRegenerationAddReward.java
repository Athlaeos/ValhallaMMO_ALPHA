...
public class AccountHealthRegenerationAddReward extends PerkReward {
     ...
     */
    public AccountHealthRegenerationAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setHealthRegenerationBonus(accountProfile.getHealthRegenerationBonus() + bonus);
