...
public class AccountHungerSaveChanceSetReward extends PerkReward {
     ...
     */
    public AccountHungerSaveChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setHungerSaveChance(bonus);
