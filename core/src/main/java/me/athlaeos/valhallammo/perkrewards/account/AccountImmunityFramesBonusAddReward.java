...
public class AccountImmunityFramesBonusAddReward extends PerkReward {
    private int frames = 0;

    public AccountImmunityFramesBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setImmunityFrameBonus(accountProfile.getImmunityFrameBonus() + frames);
