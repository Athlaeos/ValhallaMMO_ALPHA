...
public class AccountMagicResistanceAddReward extends PerkReward {
     ...
     */
    public AccountMagicResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setMagicResistance(accountProfile.getMagicResistance() + resistance);
