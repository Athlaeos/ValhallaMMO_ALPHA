...
public class UnlockAllCraftRecipesReward extends PerkReward {
    /**
     ...
     */
    public UnlockAllCraftRecipesReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            unlockedRecipes.addAll(CustomRecipeManager.getInstance().getAllCustomRecipes().values().stream().filter(
