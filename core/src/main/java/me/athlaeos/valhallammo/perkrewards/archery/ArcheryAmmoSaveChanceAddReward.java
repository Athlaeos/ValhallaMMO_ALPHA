...
public class ArcheryAmmoSaveChanceAddReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryAmmoSaveChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setAmmoSaveChance(archeryProfile.getAmmoSaveChance() + multiplier);
