...
public class ArcheryBowDamageMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryBowDamageMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setBowDamageMultiplier(archeryProfile.getBowDamageMultiplier() + multiplier);
