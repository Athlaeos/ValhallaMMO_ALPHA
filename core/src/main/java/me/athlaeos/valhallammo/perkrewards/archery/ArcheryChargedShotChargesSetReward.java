...
public class ArcheryChargedShotChargesSetReward extends PerkReward {
    private int charges = 0;

    public ArcheryChargedShotChargesSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setChargedShotCharges(charges);
