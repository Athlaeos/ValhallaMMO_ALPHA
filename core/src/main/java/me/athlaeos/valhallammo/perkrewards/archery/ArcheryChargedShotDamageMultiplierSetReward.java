...
public class ArcheryChargedShotDamageMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryChargedShotDamageMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setChargedShotDamageMultiplier(archeryProfile.getChargedShotDamageMultiplier() + multiplier);
