...
public class ArcheryChargedShotPiercingBonusAddReward extends PerkReward {
    private int cooldown = 0;

    public ArcheryChargedShotPiercingBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setChargedShotPiercingBonus(archeryProfile.getChargedShotPiercingBonus() + cooldown);
