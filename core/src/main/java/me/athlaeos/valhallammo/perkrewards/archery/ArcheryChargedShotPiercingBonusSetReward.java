...
public class ArcheryChargedShotPiercingBonusSetReward extends PerkReward {
    private int cooldown = 0;

    public ArcheryChargedShotPiercingBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setChargedShotPiercingBonus(cooldown);
