...
public class ArcheryChargedShotVelocityBonusSetReward extends PerkReward {
    private float bonus = 0F;

    public ArcheryChargedShotVelocityBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setChargedShotVelocityBonus(bonus);
