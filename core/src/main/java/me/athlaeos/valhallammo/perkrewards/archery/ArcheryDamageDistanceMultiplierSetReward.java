...
public class ArcheryDamageDistanceMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryDamageDistanceMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setDamageDistanceMultiplier(multiplier);
