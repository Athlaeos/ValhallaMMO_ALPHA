...
public class ArcheryInaccuracyAddReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryInaccuracyAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setInaccuracy(archeryProfile.getInaccuracy() + multiplier);
