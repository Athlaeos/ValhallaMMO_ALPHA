...
public class ArcheryInaccuracySetReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryInaccuracySetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setInaccuracy(multiplier);
