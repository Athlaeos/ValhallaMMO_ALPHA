...
public class ArcheryInfinityDamageMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryInfinityDamageMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setInfinityDamageMultiplier(multiplier);
