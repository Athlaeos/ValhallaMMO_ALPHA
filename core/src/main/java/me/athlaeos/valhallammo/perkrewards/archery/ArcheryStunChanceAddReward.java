...
public class ArcheryStunChanceAddReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryStunChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setStunChance(archeryProfile.getStunChance() + multiplier);
