...
public class EnchantingAnvilSkillAddReward extends PerkReward {
    private int points = 0;

    public EnchantingAnvilSkillAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof EnchantingProfile){
            ...
            enchantingProfile.setAnvilQuality(enchantingProfile.getAnvilQuality() + points);
