...
public class FarmingBreedingVanillaEXPMultiplierSetReward extends PerkReward {
    private float exp = 0F;

    public FarmingBreedingVanillaEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
