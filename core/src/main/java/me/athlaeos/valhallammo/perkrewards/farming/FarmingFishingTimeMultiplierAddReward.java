...
public class FarmingFishingTimeMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public FarmingFishingTimeMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setFishingTimeMultiplier(farmingProfile.getFishingTimeMultiplier() + multiplier);
