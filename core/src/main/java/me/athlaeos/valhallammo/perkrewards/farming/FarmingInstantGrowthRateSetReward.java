...
public class FarmingInstantGrowthRateSetReward extends PerkReward {
    private float rate = 0F;

    public FarmingInstantGrowthRateSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setInstantGrowthRate(rate);
