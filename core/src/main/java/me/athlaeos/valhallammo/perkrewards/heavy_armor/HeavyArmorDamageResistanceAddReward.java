...
public class HeavyArmorDamageResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorDamageResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setDamageResistance(heavyArmorProfile.getDamageResistance() + resistance);
