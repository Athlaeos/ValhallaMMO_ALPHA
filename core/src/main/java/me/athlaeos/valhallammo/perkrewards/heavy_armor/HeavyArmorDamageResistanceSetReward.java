...
public class HeavyArmorDamageResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorDamageResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setDamageResistance(resistance);
