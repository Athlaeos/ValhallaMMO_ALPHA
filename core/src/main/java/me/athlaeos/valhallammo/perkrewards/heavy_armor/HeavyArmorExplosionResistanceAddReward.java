...
public class HeavyArmorExplosionResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorExplosionResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setExplosionResistance(heavyArmorProfile.getExplosionResistance() + resistance);
