...
public class HeavyArmorExplosionResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorExplosionResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setExplosionResistance(resistance);
