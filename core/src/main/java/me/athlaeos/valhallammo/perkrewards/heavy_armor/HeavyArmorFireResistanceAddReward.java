...
public class HeavyArmorFireResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorFireResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setFireResistance(heavyArmorProfile.getFireResistance() + resistance);
