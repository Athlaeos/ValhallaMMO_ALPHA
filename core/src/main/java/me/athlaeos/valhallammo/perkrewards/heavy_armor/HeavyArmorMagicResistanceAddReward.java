...
public class HeavyArmorMagicResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorMagicResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setMagicResistance(heavyArmorProfile.getMagicResistance() + resistance);
