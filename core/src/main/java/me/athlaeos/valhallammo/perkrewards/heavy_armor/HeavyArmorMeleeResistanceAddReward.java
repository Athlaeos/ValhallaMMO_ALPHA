...
public class HeavyArmorMeleeResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorMeleeResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setMeleeDamageResistance(heavyArmorProfile.getMeleeDamageResistance() + resistance);
