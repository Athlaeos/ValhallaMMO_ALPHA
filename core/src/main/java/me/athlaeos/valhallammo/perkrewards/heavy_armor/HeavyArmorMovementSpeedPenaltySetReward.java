...
public class HeavyArmorMovementSpeedPenaltySetReward extends PerkReward {
    private float penalty = 0F;

    public HeavyArmorMovementSpeedPenaltySetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setMovementSpeedPenalty(penalty);
