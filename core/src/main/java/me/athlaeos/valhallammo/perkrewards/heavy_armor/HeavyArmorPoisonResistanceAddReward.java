...
public class HeavyArmorPoisonResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorPoisonResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setPoisonResistance(heavyArmorProfile.getPoisonResistance() + resistance);
