...
public class HeavyArmorPoisonResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorPoisonResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setPoisonResistance(resistance);
