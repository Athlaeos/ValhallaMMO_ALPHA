...
public class HeavyArmorProjectileResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorProjectileResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setProjectileDamageResistance(resistance);
