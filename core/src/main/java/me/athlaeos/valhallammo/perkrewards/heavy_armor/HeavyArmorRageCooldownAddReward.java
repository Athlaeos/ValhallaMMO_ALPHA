...
public class HeavyArmorRageCooldownAddReward extends PerkReward {
    private int cooldown = 0;

    public HeavyArmorRageCooldownAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setRageCooldown(heavyArmorProfile.getRageCooldown() + cooldown);
