...
public class HeavyArmorSetBonusArmorSetReward extends PerkReward {
    private float pieces = 0F;

    public HeavyArmorSetBonusArmorSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setFullArmorMultiplierBonus(pieces);
