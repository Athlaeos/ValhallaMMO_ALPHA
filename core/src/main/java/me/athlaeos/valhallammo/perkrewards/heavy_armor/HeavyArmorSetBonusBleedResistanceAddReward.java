...
public class HeavyArmorSetBonusBleedResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorSetBonusBleedResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setFullArmorBleedResistance(heavyArmorProfile.getFullArmorBleedResistance() + resistance);
