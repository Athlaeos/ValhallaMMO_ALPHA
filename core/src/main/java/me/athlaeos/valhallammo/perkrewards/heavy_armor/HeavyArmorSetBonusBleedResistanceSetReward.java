...
public class HeavyArmorSetBonusBleedResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorSetBonusBleedResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setFullArmorBleedResistance(resistance);
