...
public class HeavyArmorSetBonusHealingBonusAddReward extends PerkReward {
    private float pieces = 0F;

    public HeavyArmorSetBonusHealingBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setFullArmorHealingBonus(heavyArmorProfile.getFullArmorHealingBonus() + pieces);
