...
public class HeavyArmorSetBonusHealingBonusSetReward extends PerkReward {
    private float pieces = 0F;

    public HeavyArmorSetBonusHealingBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setFullArmorHealingBonus(pieces);
