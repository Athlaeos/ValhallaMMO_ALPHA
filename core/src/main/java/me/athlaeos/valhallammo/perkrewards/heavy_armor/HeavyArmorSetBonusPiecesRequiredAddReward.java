...
public class HeavyArmorSetBonusPiecesRequiredAddReward extends PerkReward {
    private int pieces = 0;

    public HeavyArmorSetBonusPiecesRequiredAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setArmorPiecesForBonusses(heavyArmorProfile.getArmorPiecesForBonusses() + pieces);
