...
public class HeavyWeaponsAllArmorFlatIgnoredAddReward extends PerkReward {
    private float ignored = 0F;

    public HeavyWeaponsAllArmorFlatIgnoredAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFlatArmorIgnored(heavyWeaponsProfile.getFlatArmorIgnored() + ignored);
