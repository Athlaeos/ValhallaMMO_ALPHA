...
public class HeavyWeaponsAllArmorFlatIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public HeavyWeaponsAllArmorFlatIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFlatArmorIgnored(ignored);
