...
public class HeavyWeaponsAllArmorFractionIgnoredAddReward extends PerkReward {
    private float ignored = 0F;

    public HeavyWeaponsAllArmorFractionIgnoredAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFractionArmorIgnored(heavyWeaponsProfile.getFractionArmorIgnored() + ignored);
