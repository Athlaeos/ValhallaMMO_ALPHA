...
public class HeavyWeaponsAllArmorFractionIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public HeavyWeaponsAllArmorFractionIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFractionArmorIgnored(ignored);
