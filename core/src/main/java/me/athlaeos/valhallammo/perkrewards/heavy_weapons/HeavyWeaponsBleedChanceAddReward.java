...
public class HeavyWeaponsBleedChanceAddReward extends PerkReward {
    private float chance = 0F;

    public HeavyWeaponsBleedChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setBleedChance(heavyWeaponsProfile.getBleedChance() + chance);
