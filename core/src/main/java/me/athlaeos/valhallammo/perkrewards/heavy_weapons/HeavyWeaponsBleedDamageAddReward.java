...
public class HeavyWeaponsBleedDamageAddReward extends PerkReward {
    private float damage = 0F;

    public HeavyWeaponsBleedDamageAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setBleedDamage(heavyWeaponsProfile.getBleedDamage() + damage);
