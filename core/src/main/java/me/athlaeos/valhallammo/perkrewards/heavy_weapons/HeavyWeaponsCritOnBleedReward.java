...
public class HeavyWeaponsCritOnBleedReward extends PerkReward {
    private boolean enable = false;

    public HeavyWeaponsCritOnBleedReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setCritOnBleed(enable);
