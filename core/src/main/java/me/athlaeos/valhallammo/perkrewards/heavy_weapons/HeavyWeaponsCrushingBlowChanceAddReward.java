...
public class HeavyWeaponsCrushingBlowChanceAddReward extends PerkReward {
    private float chance = 0F;

    public HeavyWeaponsCrushingBlowChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setCrushingBlowChance(heavyWeaponsProfile.getCrushingBlowChance() + chance);
