...
public class HeavyWeaponsCrushingBlowCooldownAddReward extends PerkReward {
    private int cooldown = 0;

    public HeavyWeaponsCrushingBlowCooldownAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setCrushingBlowCooldown(heavyWeaponsProfile.getCrushingBlowCooldown() + cooldown);
