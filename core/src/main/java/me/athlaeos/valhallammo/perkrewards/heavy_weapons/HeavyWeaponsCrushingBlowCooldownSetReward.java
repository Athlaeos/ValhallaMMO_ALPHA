...
public class HeavyWeaponsCrushingBlowCooldownSetReward extends PerkReward {
    private int cooldown = 0;

    public HeavyWeaponsCrushingBlowCooldownSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setCrushingBlowCooldown(cooldown);
