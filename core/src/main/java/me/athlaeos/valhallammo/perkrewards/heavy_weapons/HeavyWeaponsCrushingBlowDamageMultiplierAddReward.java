...
public class HeavyWeaponsCrushingBlowDamageMultiplierAddReward extends PerkReward {
    private float damage = 0F;

    public HeavyWeaponsCrushingBlowDamageMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setCrushingBlowDamageMultiplier(heavyWeaponsProfile.getCrushingBlowDamageMultiplier() + damage);
