...
public class HeavyWeaponsDropsBonusSetReward extends PerkReward {
    private float bonus = 0F;

    public HeavyWeaponsDropsBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setDropBonus(bonus);
