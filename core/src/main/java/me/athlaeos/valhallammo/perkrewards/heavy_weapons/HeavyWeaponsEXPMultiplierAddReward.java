...
public class HeavyWeaponsEXPMultiplierAddReward extends PerkReward {
    private double multiplier = 0D;

    public HeavyWeaponsEXPMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setExpMultiplier(heavyWeaponsProfile.getExpMultiplier() + multiplier);
