...
public class HeavyWeaponsHeavyArmorDamageBonusAddReward extends PerkReward {
    private float bonus = 0F;

    public HeavyWeaponsHeavyArmorDamageBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setDamageBonusHeavyArmor(heavyWeaponsProfile.getDamageBonusHeavyArmor() + bonus);
