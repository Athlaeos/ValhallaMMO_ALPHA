...
public class HeavyWeaponsHeavyArmorFractionIgnoredAddReward extends PerkReward {
    private float ignored = 0F;

    public HeavyWeaponsHeavyArmorFractionIgnoredAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFractionHeavyArmorIgnored(heavyWeaponsProfile.getFractionHeavyArmorIgnored() + ignored);
