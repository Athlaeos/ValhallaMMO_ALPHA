...
public class HeavyWeaponsHeavyArmorFractionIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public HeavyWeaponsHeavyArmorFractionIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFractionHeavyArmorIgnored(ignored);
