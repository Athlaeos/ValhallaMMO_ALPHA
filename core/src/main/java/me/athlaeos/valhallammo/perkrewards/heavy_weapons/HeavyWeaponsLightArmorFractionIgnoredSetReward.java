...
public class HeavyWeaponsLightArmorFractionIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public HeavyWeaponsLightArmorFractionIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFractionLightArmorIgnored(ignored);
