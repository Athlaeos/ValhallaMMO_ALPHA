...
public class HeavyWeaponsParryCooldownAddReward extends PerkReward {
    private int cooldown = 0;

    public HeavyWeaponsParryCooldownAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setParryCooldown(heavyWeaponsProfile.getParryCooldown() + cooldown);
