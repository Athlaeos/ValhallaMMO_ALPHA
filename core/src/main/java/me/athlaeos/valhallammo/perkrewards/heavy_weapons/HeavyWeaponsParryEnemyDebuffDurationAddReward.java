...
public class HeavyWeaponsParryEnemyDebuffDurationAddReward extends PerkReward {
    private int duration = 0;

    public HeavyWeaponsParryEnemyDebuffDurationAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setEnemyDebuffDuration(heavyWeaponsProfile.getEnemyDebuffDuration() + duration);
