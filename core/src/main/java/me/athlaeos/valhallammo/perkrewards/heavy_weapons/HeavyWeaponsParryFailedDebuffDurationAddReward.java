...
public class HeavyWeaponsParryFailedDebuffDurationAddReward extends PerkReward {
    private int duration = 0;

    public HeavyWeaponsParryFailedDebuffDurationAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFailedDebuffDuration(heavyWeaponsProfile.getFailedDebuffDuration() + duration);
