...
public class HeavyWeaponsParryVulnerableFrameSetReward extends PerkReward {
    private int timeFrame = 0;

    public HeavyWeaponsParryVulnerableFrameSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setParryVulnerableFrame(timeFrame);
