...
public class LandscapingDiggingEXPRewardAddReward extends PerkReward {
    private float exp = 0F;

    public LandscapingDiggingEXPRewardAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setDiggingExperienceRate(landscapingProfile.getDiggingExperienceRate() + exp);
