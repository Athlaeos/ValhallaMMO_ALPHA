...
public class LandscapingDiggingRareDropMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public LandscapingDiggingRareDropMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setDiggingRareDropRateMultiplier(landscapingProfile.getDiggingRareDropRateMultiplier() + multiplier);
