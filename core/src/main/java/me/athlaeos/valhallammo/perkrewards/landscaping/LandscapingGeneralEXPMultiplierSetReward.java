...
public class LandscapingGeneralEXPMultiplierSetReward extends PerkReward {
    private double multiplier = 0D;

    public LandscapingGeneralEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setGeneralExpMultiplier(multiplier);
