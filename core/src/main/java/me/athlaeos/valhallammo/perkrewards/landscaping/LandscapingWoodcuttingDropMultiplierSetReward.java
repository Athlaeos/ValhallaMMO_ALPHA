...
public class LandscapingWoodcuttingDropMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public LandscapingWoodcuttingDropMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
