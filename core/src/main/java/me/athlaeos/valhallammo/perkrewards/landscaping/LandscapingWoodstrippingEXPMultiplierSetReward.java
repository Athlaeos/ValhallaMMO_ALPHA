...
public class LandscapingWoodstrippingEXPMultiplierSetReward extends PerkReward {
    private double multiplier = 0D;

    public LandscapingWoodstrippingEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setWoodstrippingExpMultiplier(multiplier);
