...
public class LightArmorAdrenalineThresholdAddReward extends PerkReward {
    private float threshold = 0F;

    public LightArmorAdrenalineThresholdAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setAdrenalineThreshold(lightArmorProfile.getAdrenalineThreshold() + threshold);
