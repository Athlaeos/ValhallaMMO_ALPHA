...
public class LightArmorBleedResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorBleedResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setBleedResistance(lightArmorProfile.getBleedResistance() + resistance);
