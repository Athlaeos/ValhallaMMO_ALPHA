...
public class LightArmorBleedResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorBleedResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setBleedResistance(resistance);
