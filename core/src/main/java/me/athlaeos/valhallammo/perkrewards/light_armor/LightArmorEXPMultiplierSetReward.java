...
public class LightArmorEXPMultiplierSetReward extends PerkReward {
    private double multiplier = 0D;

    public LightArmorEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setExpMultiplier(multiplier);
