...
public class LightArmorExplosionResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorExplosionResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setExplosionResistance(resistance);
