...
public class LightArmorFallDamageResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorFallDamageResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setFallDamageResistance(lightArmorProfile.getFallDamageResistance() + resistance);
