...
public class LightArmorFallDamageResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorFallDamageResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setFallDamageResistance(resistance);
