...
public class LightArmorFireResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorFireResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setFireResistance(lightArmorProfile.getFireResistance() + resistance);
