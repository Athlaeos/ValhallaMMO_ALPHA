...
public class LightArmorProjectileResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorProjectileResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setProjectileDamageResistance(resistance);
