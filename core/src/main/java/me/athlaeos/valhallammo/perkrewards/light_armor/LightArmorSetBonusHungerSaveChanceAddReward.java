...
public class LightArmorSetBonusHungerSaveChanceAddReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorSetBonusHungerSaveChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setFullArmorHungerSaveChance(lightArmorProfile.getFullArmorHungerSaveChance() + resistance);
