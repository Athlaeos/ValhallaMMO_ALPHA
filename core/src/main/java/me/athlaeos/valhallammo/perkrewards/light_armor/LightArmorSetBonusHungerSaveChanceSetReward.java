...
public class LightArmorSetBonusHungerSaveChanceSetReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorSetBonusHungerSaveChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setFullArmorHungerSaveChance(resistance);
