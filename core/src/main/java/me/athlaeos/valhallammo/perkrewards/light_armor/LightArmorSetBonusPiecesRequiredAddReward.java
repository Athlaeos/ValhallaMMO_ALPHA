...
public class LightArmorSetBonusPiecesRequiredAddReward extends PerkReward {
    private int pieces = 0;

    public LightArmorSetBonusPiecesRequiredAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setArmorPiecesForBonusses(lightArmorProfile.getArmorPiecesForBonusses() + pieces);
