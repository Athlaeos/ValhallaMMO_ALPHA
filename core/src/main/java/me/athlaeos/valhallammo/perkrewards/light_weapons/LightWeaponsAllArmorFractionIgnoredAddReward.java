...
public class LightWeaponsAllArmorFractionIgnoredAddReward extends PerkReward {
    private float ignored = 0F;

    public LightWeaponsAllArmorFractionIgnoredAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFractionArmorIgnored(lightWeaponsProfile.getFractionArmorIgnored() + ignored);
