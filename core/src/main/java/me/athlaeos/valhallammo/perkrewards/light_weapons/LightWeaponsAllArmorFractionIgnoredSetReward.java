...
public class LightWeaponsAllArmorFractionIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public LightWeaponsAllArmorFractionIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFractionArmorIgnored(ignored);
