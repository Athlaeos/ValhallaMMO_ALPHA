...
public class LightWeaponsAttackSpeedBonusAddReward extends PerkReward {
    private float bonus = 0F;

    public LightWeaponsAttackSpeedBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setAttackSpeedBonus(lightWeaponsProfile.getAttackSpeedBonus() + bonus);
