...
public class LightWeaponsBleedChanceSetReward extends PerkReward {
    private float chance = 0F;

    public LightWeaponsBleedChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setBleedChance(chance);
