...
public class LightWeaponsBleedDurationAddReward extends PerkReward {
    private int duration = 0;

    public LightWeaponsBleedDurationAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setBleedDuration(lightWeaponsProfile.getBleedDuration() + duration);
