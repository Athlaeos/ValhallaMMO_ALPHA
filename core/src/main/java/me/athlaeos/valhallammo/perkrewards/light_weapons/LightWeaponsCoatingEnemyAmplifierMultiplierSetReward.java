...
public class LightWeaponsCoatingEnemyAmplifierMultiplierSetReward extends PerkReward {
    private float duration = 0F;

    public LightWeaponsCoatingEnemyAmplifierMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setEnemyPotionAmplifierMultiplier(duration);
