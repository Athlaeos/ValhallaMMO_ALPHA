...
public class LightWeaponsCoatingEnemyDurationMultiplierSetReward extends PerkReward {
    private float duration = 0F;

    public LightWeaponsCoatingEnemyDurationMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setEnemyPotionDurationMultiplier(duration);
