...
public class LightWeaponsCoatingSelfDurationMultiplierSetReward extends PerkReward {
    private float duration = 0F;

    public LightWeaponsCoatingSelfDurationMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setSelfPotionDurationMultiplier(duration);
