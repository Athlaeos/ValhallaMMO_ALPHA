...
public class LightWeaponsCritChanceAddReward extends PerkReward {
    private float chance = 0F;

    public LightWeaponsCritChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setCritChance(lightWeaponsProfile.getCritChance() + chance);
