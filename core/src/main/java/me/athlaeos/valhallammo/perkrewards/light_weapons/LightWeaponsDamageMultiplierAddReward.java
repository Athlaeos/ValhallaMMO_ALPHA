...
public class LightWeaponsDamageMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public LightWeaponsDamageMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setDamageMultiplier(lightWeaponsProfile.getDamageMultiplier() + multiplier);
