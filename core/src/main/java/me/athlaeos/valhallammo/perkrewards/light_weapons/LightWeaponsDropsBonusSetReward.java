...
public class LightWeaponsDropsBonusSetReward extends PerkReward {
    private float bonus = 0F;

    public LightWeaponsDropsBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setDropBonus(bonus);
