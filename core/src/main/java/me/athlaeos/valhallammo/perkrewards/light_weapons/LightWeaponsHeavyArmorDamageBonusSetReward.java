...
public class LightWeaponsHeavyArmorDamageBonusSetReward extends PerkReward {
    private float bonus = 0F;

    public LightWeaponsHeavyArmorDamageBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setDamageBonusHeavyArmor(bonus);
