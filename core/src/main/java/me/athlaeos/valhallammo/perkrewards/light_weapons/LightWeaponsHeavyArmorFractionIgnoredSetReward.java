...
public class LightWeaponsHeavyArmorFractionIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public LightWeaponsHeavyArmorFractionIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFractionHeavyArmorIgnored(ignored);
