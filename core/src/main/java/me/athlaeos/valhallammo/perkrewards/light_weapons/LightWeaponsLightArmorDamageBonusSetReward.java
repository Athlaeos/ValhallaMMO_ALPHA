...
public class LightWeaponsLightArmorDamageBonusSetReward extends PerkReward {
    private float bonus = 0F;

    public LightWeaponsLightArmorDamageBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setDamageBonusLightArmor(bonus);
