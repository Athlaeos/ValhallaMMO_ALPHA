...
public class LightWeaponsParryDamageReductionAddReward extends PerkReward {
    private float reduction = 0F;

    public LightWeaponsParryDamageReductionAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setParryDamageReduction(lightWeaponsProfile.getParryDamageReduction() + reduction);
