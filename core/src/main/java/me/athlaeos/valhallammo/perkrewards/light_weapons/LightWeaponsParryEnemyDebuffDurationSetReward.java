...
public class LightWeaponsParryEnemyDebuffDurationSetReward extends PerkReward {
    private int duration = 0;

    public LightWeaponsParryEnemyDebuffDurationSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setEnemyDebuffDuration(duration);
