...
public class LightWeaponsParryFailedDebuffDurationAddReward extends PerkReward {
    private int duration = 0;

    public LightWeaponsParryFailedDebuffDurationAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFailedDebuffDuration(lightWeaponsProfile.getFailedDebuffDuration() + duration);
