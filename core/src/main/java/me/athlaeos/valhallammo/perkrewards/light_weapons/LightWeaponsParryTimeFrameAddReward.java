...
public class LightWeaponsParryTimeFrameAddReward extends PerkReward {
    private int timeFrame = 0;

    public LightWeaponsParryTimeFrameAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setParryTimeFrame(lightWeaponsProfile.getParryTimeFrame() + timeFrame);
