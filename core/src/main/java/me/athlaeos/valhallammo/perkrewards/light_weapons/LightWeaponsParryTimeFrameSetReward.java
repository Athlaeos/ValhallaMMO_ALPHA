...
public class LightWeaponsParryTimeFrameSetReward extends PerkReward {
    private int timeFrame = 0;

    public LightWeaponsParryTimeFrameSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setParryTimeFrame(timeFrame);
