...
public class LightWeaponsStunDurationAddReward extends PerkReward {
    private int duration = 0;

    public LightWeaponsStunDurationAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setStunDuration(lightWeaponsProfile.getStunDuration() + duration);
