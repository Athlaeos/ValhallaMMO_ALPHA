...
public class MiningBlastDamageMultiplierSetReward extends PerkReward {
    private float exp = 0F;

    public MiningBlastDamageMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setTntExplosionDamageMultiplier(exp);
