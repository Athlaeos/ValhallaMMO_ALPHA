...
public class MiningBlastDropMultiplierSetReward extends PerkReward {
    private float exp = 0F;

    public MiningBlastDropMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setBlastMiningDropMultiplier(exp);
