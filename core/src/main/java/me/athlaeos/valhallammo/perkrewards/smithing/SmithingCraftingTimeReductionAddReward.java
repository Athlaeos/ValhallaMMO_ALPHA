...
public class SmithingCraftingTimeReductionAddReward extends PerkReward {
    private float reduction = 0F;

    public SmithingCraftingTimeReductionAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof SmithingProfile){
            ...
            smithingProfile.setCraftingTimeReduction(smithingProfile.getCraftingTimeReduction() + reduction);
