...
public class ArcheryChargedShotFullVelocity extends Placeholder {
    private final String unlocked;
    private final String locked;

    public ArcheryChargedShotFullVelocity(String placeholder) {
        super(placeholder);
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof ArcheryProfile){
                boolean stunOnCrit = ((ArcheryProfile) profile).isChargedShotFullVelocity();
                if (stunOnCrit){
