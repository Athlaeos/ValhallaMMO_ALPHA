...
public class ArcheryCritOnStealth extends Placeholder {
    private final String unlocked;
    private final String locked;

    public ArcheryCritOnStealth(String placeholder) {
        super(placeholder);
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof ArcheryProfile){
                boolean critOnStealth = ((ArcheryProfile) profile).isCritOnStealth();
                if (critOnStealth){
