...
public class ArcheryCrossbowDamageMultiplier extends Placeholder {
    public ArcheryCrossbowDamageMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof ArcheryProfile){
                float multiplier = ((ArcheryProfile) profile).getCrossBowDamageMultiplier();
