...
public class HeavyArmorKnockbackResistance extends Placeholder {
    public HeavyArmorKnockbackResistance(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyArmorProfile){
                float resistance = ((HeavyArmorProfile) profile).getKnockbackResistance();
