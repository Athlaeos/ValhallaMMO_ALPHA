...
public class HeavyWeaponsCrushingBlowOnCrit extends Placeholder {
    private final String unlocked;
    private final String locked;

    public HeavyWeaponsCrushingBlowOnCrit(String placeholder) {
        super(placeholder);
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                boolean enabled = ((HeavyWeaponsProfile) profile).isCrushingBlowOnCrit();
                if (enabled){
