...
public class HeavyWeaponsCrushingBlowOnFalling extends Placeholder {
    private final String unlocked;
    private final String locked;

    public HeavyWeaponsCrushingBlowOnFalling(String placeholder) {
        super(placeholder);
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                boolean enabled = ((HeavyWeaponsProfile) profile).isCrushingBlowOnFalling();
                if (enabled){
