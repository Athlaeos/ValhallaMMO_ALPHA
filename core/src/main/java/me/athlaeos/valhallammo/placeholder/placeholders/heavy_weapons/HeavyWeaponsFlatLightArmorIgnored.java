...
public class HeavyWeaponsFlatLightArmorIgnored extends Placeholder {
    public HeavyWeaponsFlatLightArmorIgnored(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                float ignored = ((HeavyWeaponsProfile) profile).getFlatLightArmorIgnored();
