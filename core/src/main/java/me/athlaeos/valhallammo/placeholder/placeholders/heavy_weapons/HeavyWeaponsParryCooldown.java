...
public class HeavyWeaponsParryCooldown extends Placeholder {
    public HeavyWeaponsParryCooldown(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                int frame = ((HeavyWeaponsProfile) profile).getParryCooldown();
                if (frame == -1){
