...
public class DiggingDropMultiplier extends Placeholder {
    public DiggingDropMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LandscapingProfile){
                float multiplier = ((LandscapingProfile) profile).getDiggingDropMultiplier();
