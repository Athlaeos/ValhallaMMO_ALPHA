...
public class LightArmorDamageResistance extends Placeholder {
    public LightArmorDamageResistance(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LightArmorProfile){
                float penalty = ((LightArmorProfile) profile).getDamageResistance();
