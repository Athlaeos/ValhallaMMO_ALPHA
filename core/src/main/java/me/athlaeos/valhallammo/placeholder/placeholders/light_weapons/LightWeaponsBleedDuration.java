...
public class LightWeaponsBleedDuration extends Placeholder {
    public LightWeaponsBleedDuration(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LightWeaponsProfile){
                int frame = ((LightWeaponsProfile) profile).getBleedDuration();
                if (frame == -1){
