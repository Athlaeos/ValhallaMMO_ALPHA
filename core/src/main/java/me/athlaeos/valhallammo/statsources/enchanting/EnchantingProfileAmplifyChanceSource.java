...
public class EnchantingProfileAmplifyChanceSource extends AccumulativeStatSource {
    public EnchantingProfileAmplifyChanceSource(){
    }
    ...
    public double add(Entity p, boolean use) {
        if (p instanceof Player){
            ...
            return enchantingProfile.getVanillaEnchantmentAmplifyChance();
        }
        return 0;
    }
}
