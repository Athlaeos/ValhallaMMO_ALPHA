...
public class HeavyArmorProfileEquipmentFireResistanceSource extends AccumulativeStatSource {
    @Override
        ...
        if (p instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof HeavyArmorProfile){
                    double resistancePerPiece = ((HeavyArmorProfile) profile).getFireResistance();
