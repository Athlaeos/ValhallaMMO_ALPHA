...
public class HeavyArmorProfileEquipmentMagicResistanceSource extends AccumulativeStatSource {
    @Override
        ...
        if (p instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof HeavyArmorProfile){
                    double resistancePerPiece = ((HeavyArmorProfile) profile).getMagicResistance();
