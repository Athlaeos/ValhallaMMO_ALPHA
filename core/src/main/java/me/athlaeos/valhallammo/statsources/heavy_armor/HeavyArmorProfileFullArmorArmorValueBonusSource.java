...
public class HeavyArmorProfileFullArmorArmorValueBonusSource extends AccumulativeStatSource {
    @Override
            ...
            if (profile != null){
                if (profile instanceof HeavyArmorProfile){
                    ...
                    if (count >= ((HeavyArmorProfile) profile).getArmorPiecesForBonusses()){
                        return ((HeavyArmorProfile) profile).getFullArmorMultiplierBonus();
                    } else {
                        return 0;
                    }
                }
