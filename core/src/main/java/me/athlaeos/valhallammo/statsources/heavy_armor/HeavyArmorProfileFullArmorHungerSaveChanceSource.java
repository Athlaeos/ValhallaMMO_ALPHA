...
public class HeavyArmorProfileFullArmorHungerSaveChanceSource extends AccumulativeStatSource {
    @Override
            ...
            if (profile != null){
                if (profile instanceof HeavyArmorProfile){
                    ...
                    if (count >= ((HeavyArmorProfile) profile).getArmorPiecesForBonusses()){
                        return ((HeavyArmorProfile) profile).getFullArmorHungerSaveChance();
                    } else {
                        return 0;
                    }
                }
