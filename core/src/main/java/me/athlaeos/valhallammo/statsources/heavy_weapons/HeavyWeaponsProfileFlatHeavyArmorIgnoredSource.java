...
public class HeavyWeaponsProfileFlatHeavyArmorIgnoredSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (offender instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof HeavyWeaponsProfile){
                    return ((HeavyWeaponsProfile) profile).getFlatHeavyArmorIgnored();
                }
            }
        }
        return 0;
