...
public class HeavyWeaponsProfileFractionLightArmorIgnoredSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (offender instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof HeavyWeaponsProfile){
                    return ((HeavyWeaponsProfile) profile).getFractionLightArmorIgnored();
                }
            }
        }
        return 0;
