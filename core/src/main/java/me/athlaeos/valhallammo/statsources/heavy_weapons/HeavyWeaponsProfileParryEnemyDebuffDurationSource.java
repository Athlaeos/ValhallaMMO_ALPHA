...
public class HeavyWeaponsProfileParryEnemyDebuffDurationSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (entity instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof HeavyWeaponsProfile){
                    return ((HeavyWeaponsProfile) profile).getEnemyDebuffDuration();
                }
            }
        }
        return 0;
