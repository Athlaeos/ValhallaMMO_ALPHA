...
public class LandscapingProfileWoodstrippingRareDropChanceMultiplierSource extends AccumulativeStatSource {
    ...
    public double add(Entity p, boolean use) {
        if (p instanceof Player){
            ...
            return landscapingProfile.getWoodstrippingRareDropRateMultiplier();
        }
        return 0;
    }
}
