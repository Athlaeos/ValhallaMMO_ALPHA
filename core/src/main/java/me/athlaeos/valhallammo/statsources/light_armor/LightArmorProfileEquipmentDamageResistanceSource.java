...
public class LightArmorProfileEquipmentDamageResistanceSource extends AccumulativeStatSource {
    @Override
        ...
        if (p instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof LightArmorProfile){
                    double resistancePerPiece = ((LightArmorProfile) profile).getDamageResistance();
