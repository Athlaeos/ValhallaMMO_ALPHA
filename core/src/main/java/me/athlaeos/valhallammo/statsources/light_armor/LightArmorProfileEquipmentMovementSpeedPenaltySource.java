...
public class LightArmorProfileEquipmentMovementSpeedPenaltySource extends AccumulativeStatSource {
    @Override
        ...
        if (p instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof LightArmorProfile){
                    double penaltyPerPiece = ((LightArmorProfile) profile).getMovementSpeedPenalty();
                    ...
                    return -lightArmorCount * penaltyPerPiece;
                }
            }
        }
        return 0;
