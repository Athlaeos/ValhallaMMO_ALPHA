...
public class LightArmorProfileFullArmorBleedResistanceSource extends AccumulativeStatSource {
    @Override
            ...
            if (profile != null){
                if (profile instanceof LightArmorProfile){
                    ...
                    if (count >= ((LightArmorProfile) profile).getArmorPiecesForBonusses()){
                        return ((LightArmorProfile) profile).getFullArmorBleedResistance();
                    } else {
                        return 0;
                    }
                }
