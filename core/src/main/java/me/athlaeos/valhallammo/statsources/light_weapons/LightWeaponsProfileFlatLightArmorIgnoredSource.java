...
public class LightWeaponsProfileFlatLightArmorIgnoredSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (offender instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof LightWeaponsProfile){
                    return ((LightWeaponsProfile) profile).getFlatLightArmorIgnored();
                }
            }
        }
        return 0;
