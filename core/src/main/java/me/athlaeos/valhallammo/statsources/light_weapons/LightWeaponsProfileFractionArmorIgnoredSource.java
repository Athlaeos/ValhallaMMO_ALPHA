...
public class LightWeaponsProfileFractionArmorIgnoredSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (offender instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof LightWeaponsProfile){
                    return ((LightWeaponsProfile) profile).getFractionArmorIgnored();
                }
            }
        }
        return 0;
