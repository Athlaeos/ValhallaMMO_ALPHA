...
public class LightWeaponsProfileImmunityFrameReductionSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (offender instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof LightWeaponsProfile){
                    return -((LightWeaponsProfile) profile).getImmunityFrameReduction();
                }
            }
        }
        return 0;
