...
public class LightWeaponsProfileLightArmorDamageBonusSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (p instanceof LivingEntity && e instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof LightWeaponsProfile){
                    return ((LightWeaponsProfile) profile).getDamageBonusLightArmor() * armorCount;
                }
            }
        }
        return 0;
