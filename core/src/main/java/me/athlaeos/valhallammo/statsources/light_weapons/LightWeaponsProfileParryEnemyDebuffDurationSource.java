...
public class LightWeaponsProfileParryEnemyDebuffDurationSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (entity instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof LightWeaponsProfile){
                    return ((LightWeaponsProfile) profile).getEnemyDebuffDuration();
                }
            }
        }
        return 0;
