...
public class LightWeaponsProfileParryFailedDebuffDurationSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (entity instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof LightWeaponsProfile){
                    return ((LightWeaponsProfile) profile).getFailedDebuffDuration();
                }
            }
        }
        return 0;
