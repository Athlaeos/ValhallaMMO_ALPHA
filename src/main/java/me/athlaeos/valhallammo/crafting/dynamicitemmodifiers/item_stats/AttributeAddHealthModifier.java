...
public class AttributeAddHealthModifier extends DynamicItemModifier {
    ...
    public ItemStack processItem(Player crafter, ItemStack outputItem) {
        ...
        ItemAttributesManager.getInstance().addDefaultStat(outputItem, new VanillaMaxHealthWrapper(strength, AttributeModifier.Operation.ADD_NUMBER, ItemUtils.getEquipmentSlot(outputItem.getType())));
        return outputItem;
    }
