...
public class AttributeAddMovementSpeedModifier extends DynamicItemModifier {
    public AttributeAddMovementSpeedModifier(String name, double strength, ModifierPriority priority) {
    ...
    public ItemStack processItem(Player crafter, ItemStack outputItem) {
        ...
        ItemAttributesManager.getInstance().addDefaultStat(outputItem, new VanillaMovementSpeedWrapper(strength, AttributeModifier.Operation.ADD_SCALAR, ItemUtils.getEquipmentSlot(outputItem.getType())));
        return outputItem;
    }
