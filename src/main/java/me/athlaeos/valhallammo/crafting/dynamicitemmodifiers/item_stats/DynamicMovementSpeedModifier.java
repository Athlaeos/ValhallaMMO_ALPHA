...
public class DynamicMovementSpeedModifier extends DynamicItemModifier {
    ...
    public ItemStack processItem(Player crafter, ItemStack outputItem) {
        ...
        SmithingItemTreatmentManager.getInstance().applyAttributeScaling(outputItem, finalQuality, "GENERIC_MOVEMENT_SPEED");
        return outputItem;
    }

    @Override
    public String toString() {
        return Utils.chat(String.format("&7Setting the item's movement speed to be &e%s%%&7 efficient with its quality score.", strength));
    }
}
