...
public class PotionDynamicQualityRatingModifier extends DynamicItemModifier implements Cloneable{
    ...
    public ItemStack processItem(Player crafter, ItemStack outputItem) {
        ...
        Profile profile = ProfileUtil.getProfile(crafter, SkillType.ALCHEMY);
        ...
        PotionTreatmentManager.getInstance().setPotionQuality(outputItem, (int) (specificSkill + generalSkill));
        return outputItem;
    }
