...
public class ValhallaFailedParryEvent extends EntityEvent implements Cancellable {
    ...
    public ValhallaFailedParryEvent(LivingEntity parrier, LivingEntity parried, int debuffDuration) {
        super(parrier);
