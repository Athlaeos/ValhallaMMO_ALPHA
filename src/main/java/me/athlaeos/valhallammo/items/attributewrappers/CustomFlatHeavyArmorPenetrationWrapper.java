...
public class CustomFlatHeavyArmorPenetrationWrapper extends AttributeWrapper{
    private final String displayLore = Utils.chat(TranslationManager.getInstance().getTranslation("translation_heavyarmorpiercingflat"));

    public CustomFlatHeavyArmorPenetrationWrapper(double amount, AttributeModifier.Operation operation, EquipmentSlot slot) {
        super(amount, operation, slot);
        this.attribute = "CUSTOM_FLAT_HEAVY_ARMOR_PENETRATION";
