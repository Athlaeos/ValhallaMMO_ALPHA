...
public class CustomFlatLightArmorPenetrationWrapper extends AttributeWrapper{
    private final String displayLore = Utils.chat(TranslationManager.getInstance().getTranslation("translation_lightarmorpiercingflat"));

    public CustomFlatLightArmorPenetrationWrapper(double amount, AttributeModifier.Operation operation, EquipmentSlot slot) {
        super(amount, operation, slot);
        this.attribute = "CUSTOM_FLAT_LIGHT_ARMOR_PENETRATION";
