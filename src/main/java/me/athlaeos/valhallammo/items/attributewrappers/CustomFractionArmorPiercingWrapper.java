...
public class CustomFractionArmorPiercingWrapper extends AttributeWrapper{
    private final String displayLore = Utils.chat(TranslationManager.getInstance().getTranslation("translation_armorpiercingfraction"));

    public CustomFractionArmorPiercingWrapper(double amount, AttributeModifier.Operation operation, EquipmentSlot slot) {
        super(amount, operation, slot);
        this.attribute = "CUSTOM_FRACTION_ARMOR_PENETRATION";
