...
public class CustomImmunityFrameBonusWrapper extends AttributeWrapper{
    private final String displayLore = Utils.chat(TranslationManager.getInstance().getTranslation("translation_immunityframefractionbonus"));

    public CustomImmunityFrameBonusWrapper(double amount, AttributeModifier.Operation operation, EquipmentSlot slot) {
        super(amount, operation, slot);
        this.attribute = "CUSTOM_FRACTION_IMMUNITY_FRAME_BONUS";
