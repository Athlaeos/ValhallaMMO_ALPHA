...
public class AlchemyQualityEnchantment extends EnchantmentWrapper {
    private final String translation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_alchemy_quality"));
    ...
    public AlchemyQualityEnchantment(double amount) {
        super(amount);
        this.attribute = "ALCHEMY_QUALITY";
