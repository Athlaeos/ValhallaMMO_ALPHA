...
public class CooldownReductionEnchantment extends EnchantmentWrapper {
    private final String display = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_cooldownreduction"));

    public CooldownReductionEnchantment(double amount) {
        super(amount);
        this.attribute = "COOLDOWN_REDUCTION";
