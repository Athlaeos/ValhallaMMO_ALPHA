...
public class DiggingExtraDropsEnchantment extends EnchantmentWrapper {
    private final String translation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_digging_extra_drops"));

    public DiggingExtraDropsEnchantment(double amount) {
        super(amount);
        this.attribute = "DIGGING_EXTRA_DROPS";
        this.minValue = -1000;
        this.maxValue = 1000;
    }
