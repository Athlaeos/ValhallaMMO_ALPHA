...
public class DiggingRareDropsEnchantment extends EnchantmentWrapper {
    private final String translation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_digging_rare_drops"));

    public DiggingRareDropsEnchantment(double amount) {
        super(amount);
        this.attribute = "DIGGING_RARE_DROPS";
        this.minValue = -1000;
        this.maxValue = 1000;
    }
