...
public class DodgeChanceEnchantment extends EnchantmentWrapper {
    private final String display = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_dodgechance"));

    public DodgeChanceEnchantment(double amount) {
        super(amount);
        this.attribute = "DODGE_CHANCE";
