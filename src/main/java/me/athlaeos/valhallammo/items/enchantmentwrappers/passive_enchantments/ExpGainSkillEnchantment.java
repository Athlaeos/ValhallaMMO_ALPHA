...
public class ExpGainSkillEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_exp_skill_gain"));

    public ExpGainSkillEnchantment(double amount) {
        super(amount);
        this.attribute = "EXP_GAIN_SKILL";
