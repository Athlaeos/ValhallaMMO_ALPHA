...
public class HealingBonusEnchantment extends EnchantmentWrapper {
    private final String display = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_healingbonus"));

    public HealingBonusEnchantment(double amount) {
        super(amount);
        this.attribute = "HEALING_BONUS";
