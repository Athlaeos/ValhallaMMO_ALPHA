...
public class HungerSaveChanceEnchantment extends EnchantmentWrapper {
    private final String display = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_hungersavechance"));

    public HungerSaveChanceEnchantment(double amount) {
        super(amount);
        this.attribute = "HUNGER_SAVE_CHANCE";
