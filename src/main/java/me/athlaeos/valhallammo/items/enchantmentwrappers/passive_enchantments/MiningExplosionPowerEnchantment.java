...
public class MiningExplosionPowerEnchantment extends EnchantmentWrapper {
    private final String display = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_explosionradius"));

    public MiningExplosionPowerEnchantment(double amount) {
        super(amount);
        this.attribute = "EXPLOSION_POWER";
