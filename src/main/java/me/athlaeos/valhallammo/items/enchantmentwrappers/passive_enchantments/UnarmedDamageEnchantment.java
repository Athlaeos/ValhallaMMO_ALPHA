...
public class UnarmedDamageEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_unarmed_damage"));
    ...
    public UnarmedDamageEnchantment(double amount) {
        super(amount);
        this.attribute = "UNARMED_DAMAGE";
