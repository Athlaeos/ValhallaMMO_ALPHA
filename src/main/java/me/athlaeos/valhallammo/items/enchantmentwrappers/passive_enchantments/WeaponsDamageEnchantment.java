...
public class WeaponsDamageEnchantment extends EnchantmentWrapper {
    private final String rangedDamageTranslation = Utils.chat(TranslationManager.getInstance().getTranslation("enchantment_weapons_damage"));
    ...
    public WeaponsDamageEnchantment(double amount) {
        super(amount);
        this.attribute = "WEAPONS_DAMAGE";
