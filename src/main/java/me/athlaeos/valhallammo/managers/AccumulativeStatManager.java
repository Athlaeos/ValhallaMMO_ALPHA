...
public class AccumulativeStatManager {
    ...
    public AccumulativeStatManager(){
        ...
        register("NON_EQUIPMENT_ARMOR", new EntityAttributeArmorRatingSource(), new ProfileBaseArmorBonusSource(), new ArbitraryPotionAmplifierSource("ARMOR_FLAT_BONUS", false));
