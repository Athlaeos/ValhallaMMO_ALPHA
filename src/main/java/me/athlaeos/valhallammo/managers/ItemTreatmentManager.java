...
public class ItemTreatmentManager {
    ...
    private final NamespacedKey key_treatment = new NamespacedKey(Main.getPlugin(), "valhalla_treatments");
    private final NamespacedKey key_quality = new NamespacedKey(Main.getPlugin(), "valhalla_item_quality");
     ...
     * overwritten.
     * Using a new attribute will also automatically create the scaling buttons for the attribute for use within the
     * recipe menus: a set default, a remove default, and dynamic scaling button.
