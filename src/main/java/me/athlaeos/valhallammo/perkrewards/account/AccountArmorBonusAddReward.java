...
public class AccountArmorBonusAddReward extends PerkReward {
     ...
     */
    public AccountArmorBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setArmorBonus(accountProfile.getArmorBonus() + bonus);
