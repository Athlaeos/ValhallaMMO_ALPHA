...
public class AccountArmorBonusSetReward extends PerkReward {
     ...
     */
    public AccountArmorBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setArmorBonus(bonus);
