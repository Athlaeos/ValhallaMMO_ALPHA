...
public class AccountArmorMultiplierBonusAddReward extends PerkReward {
     ...
     */
    public AccountArmorMultiplierBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setArmorMultiplierBonus(accountProfile.getArmorMultiplierBonus() + bonus);
