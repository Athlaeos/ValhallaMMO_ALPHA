...
public class AccountArmorMultiplierBonusSetReward extends PerkReward {
     ...
     */
    public AccountArmorMultiplierBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setArmorMultiplierBonus(bonus);
