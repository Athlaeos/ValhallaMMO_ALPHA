...
public class AccountAttackSpeedBonusAddReward extends PerkReward {
     ...
     */
    public AccountAttackSpeedBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setAttackSpeedBonus(accountProfile.getAttackSpeedBonus() + bonus);
