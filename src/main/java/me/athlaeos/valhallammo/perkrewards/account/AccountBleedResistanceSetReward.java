...
public class AccountBleedResistanceSetReward extends PerkReward {
     ...
     */
    public AccountBleedResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setBleedResistance(resistance);
