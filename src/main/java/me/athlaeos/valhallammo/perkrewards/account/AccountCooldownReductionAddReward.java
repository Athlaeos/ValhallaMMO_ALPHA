...
public class AccountCooldownReductionAddReward extends PerkReward {
     ...
     */
    public AccountCooldownReductionAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setCooldownReduction(accountProfile.getCooldownReduction() + cooldownReduction);
    ...
    public void setArgument(Object argument) {
        ...
        if (argument != null){
            if (argument instanceof Integer){
                cooldownReduction = (float) (Integer) argument;
            }
            if (argument instanceof Float){
                cooldownReduction = (float) argument;
            }
            if (argument instanceof Double){
                double temp = (Double) argument;
                cooldownReduction = (float) temp;
            }
        }
    }
