...
public class AccountCooldownReductionSetReward extends PerkReward {
     ...
     */
    public AccountCooldownReductionSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setCooldownReduction(cooldownReduction);
