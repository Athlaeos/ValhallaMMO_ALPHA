...
public class AccountDamageResistanceSetReward extends PerkReward {
     ...
     */
    public AccountDamageResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setDamageResistance(resistance);
