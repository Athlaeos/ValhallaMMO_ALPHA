...
public class AccountExplosionResistanceAddReward extends PerkReward {
     ...
     */
    public AccountExplosionResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setExplosionResistance(accountProfile.getExplosionResistance() + resistance);
