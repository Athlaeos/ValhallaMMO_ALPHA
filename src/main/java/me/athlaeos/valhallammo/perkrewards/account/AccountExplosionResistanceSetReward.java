...
public class AccountExplosionResistanceSetReward extends PerkReward {
     ...
     */
    public AccountExplosionResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setExplosionResistance(resistance);
