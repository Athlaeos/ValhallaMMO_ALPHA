...
public class AccountFallDamageResistanceSetReward extends PerkReward {
     ...
     */
    public AccountFallDamageResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setFallDamageResistance(resistance);
