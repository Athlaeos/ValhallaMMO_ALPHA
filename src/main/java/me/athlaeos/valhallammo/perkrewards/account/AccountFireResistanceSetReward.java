...
public class AccountFireResistanceSetReward extends PerkReward {
     ...
     */
    public AccountFireResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setFireResistance(resistance);
