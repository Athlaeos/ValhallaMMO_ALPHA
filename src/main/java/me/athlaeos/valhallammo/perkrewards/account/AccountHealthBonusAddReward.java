...
public class AccountHealthBonusAddReward extends PerkReward {
     ...
     */
    public AccountHealthBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setHealthBonus(accountProfile.getHealthBonus() + bonus);
