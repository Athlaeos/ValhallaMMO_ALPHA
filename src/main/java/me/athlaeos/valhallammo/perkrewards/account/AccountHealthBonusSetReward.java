...
public class AccountHealthBonusSetReward extends PerkReward {
     ...
     */
    public AccountHealthBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setHealthBonus(bonus);
