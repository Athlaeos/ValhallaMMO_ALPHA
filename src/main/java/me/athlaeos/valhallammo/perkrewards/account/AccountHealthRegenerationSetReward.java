...
public class AccountHealthRegenerationSetReward extends PerkReward {
     ...
     */
    public AccountHealthRegenerationSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setHealthRegenerationBonus(bonus);
