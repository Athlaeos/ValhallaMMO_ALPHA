...
public class AccountHungerSaveChanceAddReward extends PerkReward {
     ...
     */
    public AccountHungerSaveChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setHungerSaveChance(accountProfile.getHungerSaveChance() + bonus);
