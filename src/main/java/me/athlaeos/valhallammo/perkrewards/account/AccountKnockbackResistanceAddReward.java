...
public class AccountKnockbackResistanceAddReward extends PerkReward {
     ...
     */
    public AccountKnockbackResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setKnockbackResistanceBonus(accountProfile.getKnockbackResistanceBonus() + bonus);
