...
public class AccountKnockbackResistanceSetReward extends PerkReward {
     ...
     */
    public AccountKnockbackResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setKnockbackResistanceBonus(bonus);
