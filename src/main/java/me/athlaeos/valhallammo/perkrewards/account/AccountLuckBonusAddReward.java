...
public class AccountLuckBonusAddReward extends PerkReward {
     ...
     */
    public AccountLuckBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setLuckBonus(accountProfile.getLuckBonus() + bonus);
