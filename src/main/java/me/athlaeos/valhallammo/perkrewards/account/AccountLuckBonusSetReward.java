...
public class AccountLuckBonusSetReward extends PerkReward {
     ...
     */
    public AccountLuckBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setLuckBonus(bonus);
