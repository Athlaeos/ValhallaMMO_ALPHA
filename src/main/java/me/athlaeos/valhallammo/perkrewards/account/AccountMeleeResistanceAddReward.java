...
public class AccountMeleeResistanceAddReward extends PerkReward {
     ...
     */
    public AccountMeleeResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setMeleeResistance(accountProfile.getMeleeResistance() + resistance);
