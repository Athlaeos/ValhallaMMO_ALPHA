...
public class AccountMovementSpeedBonusSetReward extends PerkReward {
     ...
     */
    public AccountMovementSpeedBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setMovementSpeedBonus(bonus);
