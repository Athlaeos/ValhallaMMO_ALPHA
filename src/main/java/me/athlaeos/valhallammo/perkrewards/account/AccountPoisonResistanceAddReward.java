...
public class AccountPoisonResistanceAddReward extends PerkReward {
     ...
     */
    public AccountPoisonResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setPoisonResistance(accountProfile.getPoisonResistance() + resistance);
