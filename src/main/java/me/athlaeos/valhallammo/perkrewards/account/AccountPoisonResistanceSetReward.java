...
public class AccountPoisonResistanceSetReward extends PerkReward {
     ...
     */
    public AccountPoisonResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setPoisonResistance(resistance);
