...
public class AccountProjectileResistanceAddReward extends PerkReward {
     ...
     */
    public AccountProjectileResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setProjectileResistance(accountProfile.getProjectileResistance() + resistance);
