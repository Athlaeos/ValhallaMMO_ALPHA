...
public class AccountStunResistanceAddReward extends PerkReward {
     ...
     */
    public AccountStunResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setStunResistance(accountProfile.getStunResistance() + resistance);
