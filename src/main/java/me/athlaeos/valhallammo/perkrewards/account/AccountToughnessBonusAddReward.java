...
public class AccountToughnessBonusAddReward extends PerkReward {
     ...
     */
    public AccountToughnessBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setToughnessBonus(accountProfile.getToughnessBonus() + bonus);
