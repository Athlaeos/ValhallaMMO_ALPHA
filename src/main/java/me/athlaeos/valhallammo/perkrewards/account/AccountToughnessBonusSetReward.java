...
public class AccountToughnessBonusSetReward extends PerkReward {
     ...
     */
    public AccountToughnessBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            accountProfile.setToughnessBonus(bonus);
