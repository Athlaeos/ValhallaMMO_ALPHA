...
public class UnlockAllBrewingRecipesReward extends PerkReward {
    /**
     ...
     */
    public UnlockAllBrewingRecipesReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            unlockedRecipes.addAll(CustomRecipeManager.getInstance().getBrewingRecipes().keySet());
