...
public class UnlockAllShapedRecipesReward extends PerkReward {
    /**
     ...
     */
    public UnlockAllShapedRecipesReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AccountProfile){
            ...
            unlockedRecipes.addAll(CustomRecipeManager.getInstance().getShapedRecipes().keySet());
