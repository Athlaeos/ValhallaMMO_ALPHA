...
public class BrewingExpGainSetReward extends PerkReward {
    private double expGain = 0D;

    /**
     * Constructor for BrewingExpGainSetReward, which the player's brewing experience multiplier to a set amount.
     ...
     */
    public BrewingExpGainSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof AlchemyProfile){
            ...
            alchemyProfile.setBrewingEXPMultiplier(expGain);
