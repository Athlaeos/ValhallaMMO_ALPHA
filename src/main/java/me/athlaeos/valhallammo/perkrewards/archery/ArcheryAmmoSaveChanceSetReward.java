...
public class ArcheryAmmoSaveChanceSetReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryAmmoSaveChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setAmmoSaveChance(multiplier);
