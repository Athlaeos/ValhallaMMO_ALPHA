...
public class ArcheryBowCritChanceAddReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryBowCritChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setBowCritChance(archeryProfile.getBowCritChance() + multiplier);
