...
public class ArcheryBowCritChanceSetReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryBowCritChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setBowCritChance(multiplier);
