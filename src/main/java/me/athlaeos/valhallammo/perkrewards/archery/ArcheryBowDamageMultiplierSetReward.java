...
public class ArcheryBowDamageMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryBowDamageMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setBowDamageMultiplier(multiplier);
