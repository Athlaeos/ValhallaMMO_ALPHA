...
public class ArcheryChargedShotCooldownSetReward extends PerkReward {
    private int cooldown = 0;

    public ArcheryChargedShotCooldownSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setChargedShotCooldown(cooldown);
