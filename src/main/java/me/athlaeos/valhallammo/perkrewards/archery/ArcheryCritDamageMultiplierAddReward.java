...
public class ArcheryCritDamageMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryCritDamageMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setCritDamageMultiplier(archeryProfile.getCritDamageMultiplier() + multiplier);
