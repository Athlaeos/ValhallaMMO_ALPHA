...
public class ArcheryCritDamageMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryCritDamageMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setCritDamageMultiplier(multiplier);
