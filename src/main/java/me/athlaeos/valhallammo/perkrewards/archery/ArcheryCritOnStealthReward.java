...
public class ArcheryCritOnStealthReward extends PerkReward {
    private boolean enable = false;

    public ArcheryCritOnStealthReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setCritOnStealth(enable);
