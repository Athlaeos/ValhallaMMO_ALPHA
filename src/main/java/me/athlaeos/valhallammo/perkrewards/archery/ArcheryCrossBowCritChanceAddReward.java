...
public class ArcheryCrossBowCritChanceAddReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryCrossBowCritChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setCrossBowCritChance(archeryProfile.getCrossBowCritChance() + multiplier);
