...
public class ArcheryCrossBowCritChanceSetReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryCrossBowCritChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setCrossBowCritChance(multiplier);
