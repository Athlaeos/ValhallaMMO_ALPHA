...
public class ArcheryCrossBowDamageMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryCrossBowDamageMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setCrossBowDamageMultiplier(archeryProfile.getCrossBowDamageMultiplier() + multiplier);
