...
public class ArcheryDamageDistanceBaseMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryDamageDistanceBaseMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setDamageDistanceBaseMultiplier(multiplier);
