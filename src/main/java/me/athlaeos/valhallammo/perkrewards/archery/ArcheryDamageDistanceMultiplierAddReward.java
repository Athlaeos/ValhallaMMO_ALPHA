...
public class ArcheryDamageDistanceMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryDamageDistanceMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setDamageDistanceMultiplier(archeryProfile.getDamageDistanceMultiplier() + multiplier);
