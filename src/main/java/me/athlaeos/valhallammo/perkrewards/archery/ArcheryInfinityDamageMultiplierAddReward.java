...
public class ArcheryInfinityDamageMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryInfinityDamageMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setInfinityDamageMultiplier(archeryProfile.getInfinityDamageMultiplier() + multiplier);
