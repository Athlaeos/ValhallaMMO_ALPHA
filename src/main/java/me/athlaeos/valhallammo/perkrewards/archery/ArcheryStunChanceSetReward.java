...
public class ArcheryStunChanceSetReward extends PerkReward {
    private float multiplier = 0F;

    public ArcheryStunChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof ArcheryProfile){
            ...
            archeryProfile.setStunChance(multiplier);
