...
public class EnchantingRefundAmountSetReward extends PerkReward {
    private float chance = 0F;

    public EnchantingRefundAmountSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof EnchantingProfile){
            ...
            enchantingProfile.setExpRefundFraction(chance);
