...
public class FarmingAnimalDropMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public FarmingAnimalDropMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setAnimalDropMultiplier(farmingProfile.getAnimalDropMultiplier() + multiplier);
