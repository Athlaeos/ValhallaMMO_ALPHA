...
public class FarmingAnimalRareDropRateSetReward extends PerkReward {
    private float chance = 0F;

    public FarmingAnimalRareDropRateSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setAnimalRareDropRateMultiplier(chance);
