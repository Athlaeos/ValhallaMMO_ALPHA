...
public class FarmingBreedingEXPMultiplierSetReward extends PerkReward {
    private double multiplier = 0D;

    public FarmingBreedingEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setBreedingExpMultiplier(multiplier);
