...
public class FarmingRareDropRateAddReward extends PerkReward {
     ...
     */
    public FarmingRareDropRateAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setRareDropRateMultiplier(farmingProfile.getRareDropRateMultiplier() + chance);
