...
public class FarmingDropMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public FarmingDropMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setDropMultiplier(multiplier);
