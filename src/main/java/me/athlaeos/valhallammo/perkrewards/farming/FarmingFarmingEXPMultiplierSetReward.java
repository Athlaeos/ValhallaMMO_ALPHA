...
public class FarmingFarmingEXPMultiplierSetReward extends PerkReward {
    private double multiplier = 0D;

    public FarmingFarmingEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setFarmingExpMultiplier(multiplier);
