...
public class FarmingFishingRewardTierSetReward extends PerkReward {
    private float tier = 0F;

    public FarmingFishingRewardTierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setFishingRewardTier(tier);
