...
public class FarmingFishingTimeMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public FarmingFishingTimeMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setFishingTimeMultiplier(multiplier);
