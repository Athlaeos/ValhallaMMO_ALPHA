...
public class FarmingFishingVanillaEXPMultiplierSetReward extends PerkReward {
    private float exp = 0F;

    public FarmingFishingVanillaEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setFishingVanillaExpMultiplier(exp);
