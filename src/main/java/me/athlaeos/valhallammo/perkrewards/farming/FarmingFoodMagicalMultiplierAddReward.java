...
public class FarmingFoodMagicalMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public FarmingFoodMagicalMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setMagicalHungerMultiplier(farmingProfile.getMagicalHungerMultiplier() + multiplier);
