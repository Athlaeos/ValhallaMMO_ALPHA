...
public class FarmingFoodPescotarianMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public FarmingFoodPescotarianMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setPescotarianHungerMultiplier(farmingProfile.getPescotarianHungerMultiplier() + multiplier);
