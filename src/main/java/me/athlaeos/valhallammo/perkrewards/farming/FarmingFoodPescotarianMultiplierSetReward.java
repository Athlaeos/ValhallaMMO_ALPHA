...
public class FarmingFoodPescotarianMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public FarmingFoodPescotarianMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setPescotarianHungerMultiplier(multiplier);
