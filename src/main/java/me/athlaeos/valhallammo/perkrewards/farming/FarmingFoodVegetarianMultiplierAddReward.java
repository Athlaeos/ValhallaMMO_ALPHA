...
public class FarmingFoodVegetarianMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public FarmingFoodVegetarianMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setVegetarianHungerMultiplier(farmingProfile.getVegetarianHungerMultiplier() + multiplier);
