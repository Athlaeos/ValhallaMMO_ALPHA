...
public class FarmingFoodVegetarianMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public FarmingFoodVegetarianMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setVegetarianHungerMultiplier(multiplier);
