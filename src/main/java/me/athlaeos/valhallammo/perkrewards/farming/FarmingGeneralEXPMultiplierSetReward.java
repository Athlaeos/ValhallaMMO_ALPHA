...
public class FarmingGeneralEXPMultiplierSetReward extends PerkReward {
    private double multiplier = 0D;

    public FarmingGeneralEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setGeneralExpMultiplier(multiplier);
