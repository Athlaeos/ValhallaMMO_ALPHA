...
public class FarmingAnimalDropMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public FarmingAnimalDropMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof FarmingProfile){
            ...
            farmingProfile.setAnimalDropMultiplier(multiplier);
