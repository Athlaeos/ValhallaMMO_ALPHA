...
public class HeavyArmorArmorMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public HeavyArmorArmorMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            lightArmorProfile.setHeavyArmorMultiplier(lightArmorProfile.getHeavyArmorMultiplier() + multiplier);
