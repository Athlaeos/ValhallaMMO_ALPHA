...
public class HeavyArmorBleedResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorBleedResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setBleedResistance(heavyArmorProfile.getBleedResistance() + resistance);
