...
public class HeavyArmorEXPMultiplierSetReward extends PerkReward {
    private double multiplier = 0D;

    public HeavyArmorEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setExpMultiplier(multiplier);
