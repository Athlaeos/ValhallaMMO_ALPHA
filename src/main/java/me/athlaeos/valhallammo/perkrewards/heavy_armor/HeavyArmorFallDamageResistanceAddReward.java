...
public class HeavyArmorFallDamageResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorFallDamageResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setFallDamageResistance(heavyArmorProfile.getFallDamageResistance() + resistance);
