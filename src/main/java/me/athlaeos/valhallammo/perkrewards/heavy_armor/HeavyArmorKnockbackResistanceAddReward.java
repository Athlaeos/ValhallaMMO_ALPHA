...
public class HeavyArmorKnockbackResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorKnockbackResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setKnockbackResistance(heavyArmorProfile.getKnockbackResistance() + resistance);
