...
public class HeavyArmorKnockbackResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorKnockbackResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setKnockbackResistance(resistance);
