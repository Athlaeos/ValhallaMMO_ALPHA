...
public class HeavyArmorMagicResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorMagicResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setMagicResistance(resistance);
