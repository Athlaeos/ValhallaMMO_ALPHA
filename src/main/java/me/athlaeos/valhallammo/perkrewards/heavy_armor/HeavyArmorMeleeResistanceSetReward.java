...
public class HeavyArmorMeleeResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorMeleeResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setMeleeDamageResistance(resistance);
