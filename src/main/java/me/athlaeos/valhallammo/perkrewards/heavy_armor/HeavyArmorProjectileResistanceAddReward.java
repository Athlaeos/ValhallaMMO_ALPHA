...
public class HeavyArmorProjectileResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public HeavyArmorProjectileResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setProjectileDamageResistance(heavyArmorProfile.getProjectileDamageResistance() + resistance);
