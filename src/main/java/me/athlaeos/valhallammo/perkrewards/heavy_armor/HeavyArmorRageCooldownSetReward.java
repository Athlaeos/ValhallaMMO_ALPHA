...
public class HeavyArmorRageCooldownSetReward extends PerkReward {
    private int cooldown = 0;

    public HeavyArmorRageCooldownSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setRageCooldown(cooldown);
