...
public class HeavyArmorSetBonusArmorAddReward extends PerkReward {
    private float pieces = 0F;

    public HeavyArmorSetBonusArmorAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setFullArmorMultiplierBonus(heavyArmorProfile.getFullArmorMultiplierBonus() + pieces);
