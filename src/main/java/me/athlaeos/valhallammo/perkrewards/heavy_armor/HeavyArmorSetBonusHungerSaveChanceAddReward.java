...
public class HeavyArmorSetBonusHungerSaveChanceAddReward extends PerkReward {
    private float pieces = 0F;

    public HeavyArmorSetBonusHungerSaveChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setFullArmorHungerSaveChance(heavyArmorProfile.getFullArmorHungerSaveChance() + pieces);
