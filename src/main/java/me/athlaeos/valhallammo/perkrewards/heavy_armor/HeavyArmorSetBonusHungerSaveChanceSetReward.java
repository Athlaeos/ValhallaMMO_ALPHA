...
public class HeavyArmorSetBonusHungerSaveChanceSetReward extends PerkReward {
    private float pieces = 0F;

    public HeavyArmorSetBonusHungerSaveChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setFullArmorHungerSaveChance(pieces);
