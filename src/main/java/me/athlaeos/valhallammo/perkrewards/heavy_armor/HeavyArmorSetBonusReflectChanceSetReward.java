...
public class HeavyArmorSetBonusReflectChanceSetReward extends PerkReward {
    private float pieces = 0F;

    public HeavyArmorSetBonusReflectChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyArmorProfile){
            ...
            heavyArmorProfile.setFullArmorReflectChance(pieces);
