...
public class HeavyWeaponsAttackSpeedBonusAddReward extends PerkReward {
    private float bonus = 0F;

    public HeavyWeaponsAttackSpeedBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setAttackSpeedBonus(heavyWeaponsProfile.getAttackSpeedBonus() + bonus);
