...
public class HeavyWeaponsBleedDamageSetReward extends PerkReward {
    private float damage = 0F;

    public HeavyWeaponsBleedDamageSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setBleedDamage(damage);
