...
public class HeavyWeaponsBleedOnCritReward extends PerkReward {
    private boolean enable = false;

    public HeavyWeaponsBleedOnCritReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setBleedOnCrit(enable);
