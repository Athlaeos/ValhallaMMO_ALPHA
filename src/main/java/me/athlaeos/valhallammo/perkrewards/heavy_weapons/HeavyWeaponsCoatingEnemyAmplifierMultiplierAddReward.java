...
public class HeavyWeaponsCoatingEnemyAmplifierMultiplierAddReward extends PerkReward {
    private float duration = 0F;

    public HeavyWeaponsCoatingEnemyAmplifierMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setEnemyPotionAmplifierMultiplier(heavyWeaponsProfile.getEnemyPotionAmplifierMultiplier() + duration);
