...
public class HeavyWeaponsCoatingEnemyAmplifierMultiplierSetReward extends PerkReward {
    private float duration = 0F;

    public HeavyWeaponsCoatingEnemyAmplifierMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setEnemyPotionAmplifierMultiplier(duration);
