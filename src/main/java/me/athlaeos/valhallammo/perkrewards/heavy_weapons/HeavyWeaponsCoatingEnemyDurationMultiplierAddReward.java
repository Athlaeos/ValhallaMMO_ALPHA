...
public class HeavyWeaponsCoatingEnemyDurationMultiplierAddReward extends PerkReward {
    private float duration = 0F;

    public HeavyWeaponsCoatingEnemyDurationMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setEnemyPotionDurationMultiplier(heavyWeaponsProfile.getEnemyPotionDurationMultiplier() + duration);
