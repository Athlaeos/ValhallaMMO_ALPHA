...
public class HeavyWeaponsCoatingEnemyDurationMultiplierSetReward extends PerkReward {
    private float duration = 0F;

    public HeavyWeaponsCoatingEnemyDurationMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setEnemyPotionDurationMultiplier(duration);
