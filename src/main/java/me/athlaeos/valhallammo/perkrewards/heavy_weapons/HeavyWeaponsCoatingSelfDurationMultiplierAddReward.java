...
public class HeavyWeaponsCoatingSelfDurationMultiplierAddReward extends PerkReward {
    private float duration = 0F;

    public HeavyWeaponsCoatingSelfDurationMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setSelfPotionDurationMultiplier(heavyWeaponsProfile.getSelfPotionDurationMultiplier() + duration);
