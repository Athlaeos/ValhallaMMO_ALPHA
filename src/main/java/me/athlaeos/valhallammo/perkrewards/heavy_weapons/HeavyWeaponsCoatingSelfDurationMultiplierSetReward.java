...
public class HeavyWeaponsCoatingSelfDurationMultiplierSetReward extends PerkReward {
    private float duration = 0F;

    public HeavyWeaponsCoatingSelfDurationMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setSelfPotionDurationMultiplier(duration);
