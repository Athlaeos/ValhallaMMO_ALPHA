...
public class HeavyWeaponsCritChanceAddReward extends PerkReward {
    private float chance = 0F;

    public HeavyWeaponsCritChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setCritChance(heavyWeaponsProfile.getCritChance() + chance);
