...
public class HeavyWeaponsCritChanceSetReward extends PerkReward {
    private float chance = 0F;

    public HeavyWeaponsCritChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setCritChance(chance);
