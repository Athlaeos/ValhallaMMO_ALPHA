...
public class HeavyWeaponsCritDamageMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public HeavyWeaponsCritDamageMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setCritDamageMultiplier(heavyWeaponsProfile.getCritDamageMultiplier() + multiplier);
