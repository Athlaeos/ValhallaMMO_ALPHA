...
public class HeavyWeaponsCritOnStealthReward extends PerkReward {
    private boolean enable = false;

    public HeavyWeaponsCritOnStealthReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setCritOnStealth(enable);
