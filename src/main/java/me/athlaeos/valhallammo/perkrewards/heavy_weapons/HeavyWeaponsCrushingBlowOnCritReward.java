...
public class HeavyWeaponsCrushingBlowOnCritReward extends PerkReward {
    private boolean enable = false;

    public HeavyWeaponsCrushingBlowOnCritReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setCrushingBlowOnCrit(enable);
