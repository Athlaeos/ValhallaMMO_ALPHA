...
public class HeavyWeaponsCrushingBlowOnFallingReward extends PerkReward {
    private boolean enable = false;

    public HeavyWeaponsCrushingBlowOnFallingReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setCrushingBlowOnFalling(enable);
