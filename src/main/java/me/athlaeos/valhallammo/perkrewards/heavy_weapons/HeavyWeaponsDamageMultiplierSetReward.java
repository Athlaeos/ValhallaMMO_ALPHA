...
public class HeavyWeaponsDamageMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public HeavyWeaponsDamageMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setDamageMultiplier(multiplier);
