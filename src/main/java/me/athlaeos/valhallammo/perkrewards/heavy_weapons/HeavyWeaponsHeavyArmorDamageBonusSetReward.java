...
public class HeavyWeaponsHeavyArmorDamageBonusSetReward extends PerkReward {
    private float bonus = 0F;

    public HeavyWeaponsHeavyArmorDamageBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setDamageBonusHeavyArmor(bonus);
