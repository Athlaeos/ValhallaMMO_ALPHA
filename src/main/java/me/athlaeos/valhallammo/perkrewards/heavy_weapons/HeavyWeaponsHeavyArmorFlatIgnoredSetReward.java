...
public class HeavyWeaponsHeavyArmorFlatIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public HeavyWeaponsHeavyArmorFlatIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFlatHeavyArmorIgnored(ignored);
