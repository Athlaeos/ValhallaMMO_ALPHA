...
public class HeavyWeaponsImmunityFramereductionSetReward extends PerkReward {
    private float reduction = 0F;

    public HeavyWeaponsImmunityFramereductionSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setImmunityFrameReduction(reduction);
