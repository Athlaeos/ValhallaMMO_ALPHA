...
public class HeavyWeaponsLightArmorDamageBonusAddReward extends PerkReward {
    private float bonus = 0F;

    public HeavyWeaponsLightArmorDamageBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setDamageBonusLightArmor(heavyWeaponsProfile.getDamageBonusLightArmor() + bonus);
