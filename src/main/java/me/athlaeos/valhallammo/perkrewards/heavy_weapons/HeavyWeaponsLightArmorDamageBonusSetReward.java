...
public class HeavyWeaponsLightArmorDamageBonusSetReward extends PerkReward {
    private float bonus = 0F;

    public HeavyWeaponsLightArmorDamageBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setDamageBonusLightArmor(bonus);
