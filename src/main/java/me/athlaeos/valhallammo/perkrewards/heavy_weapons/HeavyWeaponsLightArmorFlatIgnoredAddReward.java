...
public class HeavyWeaponsLightArmorFlatIgnoredAddReward extends PerkReward {
    private float ignored = 0F;

    public HeavyWeaponsLightArmorFlatIgnoredAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFlatLightArmorIgnored(heavyWeaponsProfile.getFlatLightArmorIgnored() + ignored);
