...
public class HeavyWeaponsLightArmorFlatIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public HeavyWeaponsLightArmorFlatIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFlatLightArmorIgnored(ignored);
