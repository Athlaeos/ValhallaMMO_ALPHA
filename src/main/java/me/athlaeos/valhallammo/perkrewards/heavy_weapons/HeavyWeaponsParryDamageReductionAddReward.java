...
public class HeavyWeaponsParryDamageReductionAddReward extends PerkReward {
    private float reduction = 0F;

    public HeavyWeaponsParryDamageReductionAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setParryDamageReduction(heavyWeaponsProfile.getParryDamageReduction() + reduction);
