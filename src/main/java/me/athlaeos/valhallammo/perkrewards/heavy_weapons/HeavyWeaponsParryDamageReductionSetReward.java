...
public class HeavyWeaponsParryDamageReductionSetReward extends PerkReward {
    private float reduction = 0F;

    public HeavyWeaponsParryDamageReductionSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setParryDamageReduction(reduction);
