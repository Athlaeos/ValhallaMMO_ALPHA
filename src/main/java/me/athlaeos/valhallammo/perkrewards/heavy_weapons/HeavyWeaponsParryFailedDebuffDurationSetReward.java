...
public class HeavyWeaponsParryFailedDebuffDurationSetReward extends PerkReward {
    private int duration = 0;

    public HeavyWeaponsParryFailedDebuffDurationSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setFailedDebuffDuration(duration);
