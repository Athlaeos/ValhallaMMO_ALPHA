...
public class HeavyWeaponsParryTimeFrameAddReward extends PerkReward {
    private int timeFrame = 0;

    public HeavyWeaponsParryTimeFrameAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setParryTimeFrame(heavyWeaponsProfile.getParryTimeFrame() + timeFrame);
