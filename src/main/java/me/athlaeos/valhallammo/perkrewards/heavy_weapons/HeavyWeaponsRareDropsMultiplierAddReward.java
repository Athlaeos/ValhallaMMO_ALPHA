...
public class HeavyWeaponsRareDropsMultiplierAddReward extends PerkReward {
    private float bonus = 0F;

    public HeavyWeaponsRareDropsMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setRareDropMultiplier(heavyWeaponsProfile.getRareDropMultiplier() + bonus);
