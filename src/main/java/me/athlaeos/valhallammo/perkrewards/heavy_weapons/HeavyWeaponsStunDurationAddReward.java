...
public class HeavyWeaponsStunDurationAddReward extends PerkReward {
    private int duration = 0;

    public HeavyWeaponsStunDurationAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setStunDuration(heavyWeaponsProfile.getStunDuration() + duration);
