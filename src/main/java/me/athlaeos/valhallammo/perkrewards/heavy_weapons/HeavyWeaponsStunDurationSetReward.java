...
public class HeavyWeaponsStunDurationSetReward extends PerkReward {
    private int duration = 0;

    public HeavyWeaponsStunDurationSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setStunDuration(duration);
