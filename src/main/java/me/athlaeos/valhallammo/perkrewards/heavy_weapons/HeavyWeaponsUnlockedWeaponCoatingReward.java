...
public class HeavyWeaponsUnlockedWeaponCoatingReward extends PerkReward {
    private boolean enable = false;

    public HeavyWeaponsUnlockedWeaponCoatingReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof HeavyWeaponsProfile){
            ...
            heavyWeaponsProfile.setUnlockedWeaponCoating(enable);
