...
public class LandscapingBlockPlaceRangeAddReward extends PerkReward {
    private float range = 0F;

    public LandscapingBlockPlaceRangeAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setBlockPlaceReachBonus(landscapingProfile.getBlockPlaceReachBonus() + range);
