...
public class LandscapingDiggingDropMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public LandscapingDiggingDropMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setDiggingDropMultiplier(landscapingProfile.getDiggingDropMultiplier() + multiplier);
