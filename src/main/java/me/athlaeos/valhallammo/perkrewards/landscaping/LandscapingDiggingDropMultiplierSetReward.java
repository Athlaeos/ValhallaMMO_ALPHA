...
public class LandscapingDiggingDropMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public LandscapingDiggingDropMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setDiggingDropMultiplier(multiplier);
