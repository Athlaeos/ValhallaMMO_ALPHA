...
public class LandscapingDiggingEXPMultiplierAddReward extends PerkReward {
    private double multiplier = 0D;

    public LandscapingDiggingEXPMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setDiggingExpMultiplier(landscapingProfile.getDiggingExpMultiplier() + multiplier);
