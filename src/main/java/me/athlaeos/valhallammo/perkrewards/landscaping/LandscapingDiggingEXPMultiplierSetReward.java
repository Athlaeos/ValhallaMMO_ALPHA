...
public class LandscapingDiggingEXPMultiplierSetReward extends PerkReward {
    private double multiplier = 0D;

    public LandscapingDiggingEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setDiggingExpMultiplier(multiplier);
