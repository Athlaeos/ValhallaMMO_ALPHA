...
public class LandscapingDiggingEXPRewardSetReward extends PerkReward {
    private float exp = 0F;

    public LandscapingDiggingEXPRewardSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setDiggingExperienceRate(exp);
