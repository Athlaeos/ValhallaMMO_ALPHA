...
public class LandscapingDiggingRareDropMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public LandscapingDiggingRareDropMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setDiggingRareDropRateMultiplier(multiplier);
