...
public class LandscapingGeneralEXPMultiplierAddReward extends PerkReward {
    private double multiplier = 0D;

    public LandscapingGeneralEXPMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setGeneralExpMultiplier(landscapingProfile.getGeneralExpMultiplier() + multiplier);
