...
public class LandscapingInstantGrowthRateAddReward extends PerkReward {
    private float rate = 0F;

    public LandscapingInstantGrowthRateAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setInstantGrowthRate(landscapingProfile.getInstantGrowthRate() + rate);
