...
public class LandscapingTreeCapitatorCooldownAddReward extends PerkReward {
    private int cooldown = 0;

    public LandscapingTreeCapitatorCooldownAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setTreeCapitatorCooldown(landscapingProfile.getTreeCapitatorCooldown() + cooldown);
