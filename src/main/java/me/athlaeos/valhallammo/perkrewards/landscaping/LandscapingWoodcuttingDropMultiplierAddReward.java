...
public class LandscapingWoodcuttingDropMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public LandscapingWoodcuttingDropMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setWoodcuttingDropMultiplier(landscapingProfile.getWoodcuttingDropMultiplier() + multiplier);
