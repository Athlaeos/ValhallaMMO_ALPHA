...
public class LandscapingWoodcuttingEXPMultiplierAddReward extends PerkReward {
    private double multiplier = 0D;

    public LandscapingWoodcuttingEXPMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setWoodcuttingExpMultiplier(landscapingProfile.getWoodcuttingExpMultiplier() + multiplier);
