...
public class LandscapingWoodcuttingRareDropMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public LandscapingWoodcuttingRareDropMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setWoodcuttingRareDropRateMultiplier(landscapingProfile.getWoodcuttingRareDropRateMultiplier() + multiplier);
