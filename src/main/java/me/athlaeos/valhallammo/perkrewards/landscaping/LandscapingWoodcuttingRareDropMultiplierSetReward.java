...
public class LandscapingWoodcuttingRareDropMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public LandscapingWoodcuttingRareDropMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setWoodcuttingRareDropRateMultiplier(multiplier);
