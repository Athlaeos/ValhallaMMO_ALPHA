...
public class LandscapingWoodstrippingEXPMultiplierAddReward extends PerkReward {
    private double multiplier = 0D;

    public LandscapingWoodstrippingEXPMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LandscapingProfile){
            ...
            landscapingProfile.setWoodstrippingExpMultiplier(landscapingProfile.getWoodstrippingExpMultiplier() + multiplier);
