...
public class LightArmorAdrenalineCooldownSetReward extends PerkReward {
    private int cooldown = 0;

    public LightArmorAdrenalineCooldownSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setAdrenalineCooldown(cooldown);
