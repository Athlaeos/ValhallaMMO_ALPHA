...
public class LightArmorAdrenalineLevelAddReward extends PerkReward {
    private int level = 0;

    public LightArmorAdrenalineLevelAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setAdrenalineLevel(lightArmorProfile.getAdrenalineLevel() + level);
