...
public class LightArmorAdrenalineThresholdSetReward extends PerkReward {
    private float threshold = 0F;

    public LightArmorAdrenalineThresholdSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setAdrenalineThreshold(threshold);
