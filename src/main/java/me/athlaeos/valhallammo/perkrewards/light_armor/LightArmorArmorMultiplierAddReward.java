...
public class LightArmorArmorMultiplierAddReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorArmorMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setLightArmorMultiplier(lightArmorProfile.getLightArmorMultiplier() + resistance);
