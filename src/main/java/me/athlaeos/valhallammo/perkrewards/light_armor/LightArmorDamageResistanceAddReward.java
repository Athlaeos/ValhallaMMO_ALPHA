...
public class LightArmorDamageResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorDamageResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setDamageResistance(lightArmorProfile.getDamageResistance() + resistance);
