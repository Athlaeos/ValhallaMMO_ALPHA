...
public class LightArmorDamageResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorDamageResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setDamageResistance(resistance);
