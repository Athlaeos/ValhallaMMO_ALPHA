...
public class LightArmorExplosionResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorExplosionResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setExplosionResistance(lightArmorProfile.getExplosionResistance() + resistance);
