...
public class LightArmorKnockbackResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorKnockbackResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setKnockbackResistance(resistance);
