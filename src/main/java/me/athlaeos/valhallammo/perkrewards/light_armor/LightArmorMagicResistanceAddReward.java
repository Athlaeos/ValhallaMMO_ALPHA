...
public class LightArmorMagicResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorMagicResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setMagicResistance(lightArmorProfile.getMagicResistance() + resistance);
