...
public class LightArmorMagicResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorMagicResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setMagicResistance(resistance);
