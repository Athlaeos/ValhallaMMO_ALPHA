...
public class LightArmorMeleeResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorMeleeResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setMeleeDamageResistance(lightArmorProfile.getMeleeDamageResistance() + resistance);
