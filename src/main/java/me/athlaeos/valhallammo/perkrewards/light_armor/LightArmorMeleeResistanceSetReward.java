...
public class LightArmorMeleeResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorMeleeResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setMeleeDamageResistance(resistance);
