...
public class LightArmorMovementSpeedPenaltySetReward extends PerkReward {
    private float penalty = 0F;

    public LightArmorMovementSpeedPenaltySetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setMovementSpeedPenalty(penalty);
