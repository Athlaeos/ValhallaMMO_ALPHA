...
public class LightArmorSetBonusArmorAddReward extends PerkReward {
    private float pieces = 0F;

    public LightArmorSetBonusArmorAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setFullArmorMultiplierBonus(lightArmorProfile.getFullArmorMultiplierBonus() + pieces);
