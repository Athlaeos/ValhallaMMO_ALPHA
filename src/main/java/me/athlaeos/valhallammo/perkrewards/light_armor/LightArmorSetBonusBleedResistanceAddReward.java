...
public class LightArmorSetBonusBleedResistanceAddReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorSetBonusBleedResistanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setFullArmorBleedResistance(lightArmorProfile.getFullArmorBleedResistance() + resistance);
