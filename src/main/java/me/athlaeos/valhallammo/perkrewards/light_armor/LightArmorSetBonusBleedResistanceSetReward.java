...
public class LightArmorSetBonusBleedResistanceSetReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorSetBonusBleedResistanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setFullArmorBleedResistance(resistance);
