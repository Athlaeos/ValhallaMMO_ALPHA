...
public class LightArmorSetBonusDodgeChanceAddReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorSetBonusDodgeChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setFullArmorDodgeChance(lightArmorProfile.getFullArmorDodgeChance() + resistance);
