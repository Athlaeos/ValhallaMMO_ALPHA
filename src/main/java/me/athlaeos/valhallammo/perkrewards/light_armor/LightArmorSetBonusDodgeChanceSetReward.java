...
public class LightArmorSetBonusDodgeChanceSetReward extends PerkReward {
    private float resistance = 0F;

    public LightArmorSetBonusDodgeChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightArmorProfile){
            ...
            lightArmorProfile.setFullArmorDodgeChance(resistance);
