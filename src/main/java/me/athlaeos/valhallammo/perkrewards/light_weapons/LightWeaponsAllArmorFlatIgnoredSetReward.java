...
public class LightWeaponsAllArmorFlatIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public LightWeaponsAllArmorFlatIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFlatArmorIgnored(ignored);
