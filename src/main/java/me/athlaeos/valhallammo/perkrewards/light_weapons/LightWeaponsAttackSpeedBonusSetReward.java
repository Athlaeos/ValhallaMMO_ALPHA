...
public class LightWeaponsAttackSpeedBonusSetReward extends PerkReward {
    private float bonus = 0F;

    public LightWeaponsAttackSpeedBonusSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setAttackSpeedBonus(bonus);
