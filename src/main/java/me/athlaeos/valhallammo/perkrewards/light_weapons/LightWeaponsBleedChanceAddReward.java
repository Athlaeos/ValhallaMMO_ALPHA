...
public class LightWeaponsBleedChanceAddReward extends PerkReward {
    private float chance = 0F;

    public LightWeaponsBleedChanceAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setBleedChance(lightWeaponsProfile.getBleedChance() + chance);
