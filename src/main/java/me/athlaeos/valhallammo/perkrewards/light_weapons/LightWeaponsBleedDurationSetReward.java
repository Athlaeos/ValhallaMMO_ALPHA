...
public class LightWeaponsBleedDurationSetReward extends PerkReward {
    private int duration = 0;

    public LightWeaponsBleedDurationSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setBleedDuration(duration);
