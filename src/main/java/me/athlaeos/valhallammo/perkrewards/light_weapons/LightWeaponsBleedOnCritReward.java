...
public class LightWeaponsBleedOnCritReward extends PerkReward {
    private boolean enable = false;

    public LightWeaponsBleedOnCritReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setBleedOnCrit(enable);
