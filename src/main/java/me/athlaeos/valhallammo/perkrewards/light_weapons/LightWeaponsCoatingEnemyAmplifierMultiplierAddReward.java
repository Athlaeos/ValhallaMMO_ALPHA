...
public class LightWeaponsCoatingEnemyAmplifierMultiplierAddReward extends PerkReward {
    private float duration = 0F;

    public LightWeaponsCoatingEnemyAmplifierMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setEnemyPotionAmplifierMultiplier(lightWeaponsProfile.getEnemyPotionAmplifierMultiplier() + duration);
