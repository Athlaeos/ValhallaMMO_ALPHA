...
public class LightWeaponsCoatingEnemyDurationMultiplierAddReward extends PerkReward {
    private float duration = 0F;

    public LightWeaponsCoatingEnemyDurationMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setEnemyPotionDurationMultiplier(lightWeaponsProfile.getEnemyPotionDurationMultiplier() + duration);
