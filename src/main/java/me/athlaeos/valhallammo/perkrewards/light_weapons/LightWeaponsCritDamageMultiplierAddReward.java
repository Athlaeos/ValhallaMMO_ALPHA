...
public class LightWeaponsCritDamageMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public LightWeaponsCritDamageMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setCritDamageMultiplier(lightWeaponsProfile.getCritDamageMultiplier() + multiplier);
