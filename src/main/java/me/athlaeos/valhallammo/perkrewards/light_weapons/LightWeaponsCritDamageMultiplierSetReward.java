...
public class LightWeaponsCritDamageMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public LightWeaponsCritDamageMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setCritDamageMultiplier(multiplier);
