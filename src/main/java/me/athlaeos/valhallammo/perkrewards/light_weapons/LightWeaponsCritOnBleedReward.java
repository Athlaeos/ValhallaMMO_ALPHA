...
public class LightWeaponsCritOnBleedReward extends PerkReward {
    private boolean enable = false;

    public LightWeaponsCritOnBleedReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setCritOnBleed(enable);
