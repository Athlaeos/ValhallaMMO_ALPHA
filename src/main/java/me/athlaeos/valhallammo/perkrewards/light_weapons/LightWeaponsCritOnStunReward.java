...
public class LightWeaponsCritOnStunReward extends PerkReward {
    private boolean enable = false;

    public LightWeaponsCritOnStunReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setCritOnStun(enable);
