...
public class LightWeaponsDropsBonusAddReward extends PerkReward {
    private float bonus = 0F;

    public LightWeaponsDropsBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setDropBonus(lightWeaponsProfile.getDropBonus() + bonus);
