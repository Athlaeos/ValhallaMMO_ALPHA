...
public class LightWeaponsHeavyArmorDamageBonusAddReward extends PerkReward {
    private float bonus = 0F;

    public LightWeaponsHeavyArmorDamageBonusAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setDamageBonusHeavyArmor(lightWeaponsProfile.getDamageBonusHeavyArmor() + bonus);
