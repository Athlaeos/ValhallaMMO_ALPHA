...
public class LightWeaponsHeavyArmorFlatIgnoredAddReward extends PerkReward {
    private float ignored = 0F;

    public LightWeaponsHeavyArmorFlatIgnoredAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFlatHeavyArmorIgnored(lightWeaponsProfile.getFlatHeavyArmorIgnored() + ignored);
