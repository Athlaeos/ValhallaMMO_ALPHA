...
public class LightWeaponsHeavyArmorFlatIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public LightWeaponsHeavyArmorFlatIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFlatHeavyArmorIgnored(ignored);
