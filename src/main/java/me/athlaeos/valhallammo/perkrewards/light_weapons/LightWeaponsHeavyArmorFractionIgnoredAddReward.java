...
public class LightWeaponsHeavyArmorFractionIgnoredAddReward extends PerkReward {
    private float ignored = 0F;

    public LightWeaponsHeavyArmorFractionIgnoredAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFractionHeavyArmorIgnored(lightWeaponsProfile.getFractionHeavyArmorIgnored() + ignored);
