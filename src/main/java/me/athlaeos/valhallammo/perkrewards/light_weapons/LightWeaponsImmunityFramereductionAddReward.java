...
public class LightWeaponsImmunityFramereductionAddReward extends PerkReward {
    private float reduction = 0F;

    public LightWeaponsImmunityFramereductionAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setImmunityFrameReduction(lightWeaponsProfile.getImmunityFrameReduction() + reduction);
