...
public class LightWeaponsImmunityFramereductionSetReward extends PerkReward {
    private float reduction = 0F;

    public LightWeaponsImmunityFramereductionSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setImmunityFrameReduction(reduction);
