...
public class LightWeaponsLightArmorFlatIgnoredAddReward extends PerkReward {
    private float ignored = 0F;

    public LightWeaponsLightArmorFlatIgnoredAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFlatLightArmorIgnored(lightWeaponsProfile.getFlatLightArmorIgnored() + ignored);
