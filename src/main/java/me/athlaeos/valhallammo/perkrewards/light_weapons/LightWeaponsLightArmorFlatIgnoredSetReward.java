...
public class LightWeaponsLightArmorFlatIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public LightWeaponsLightArmorFlatIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFlatLightArmorIgnored(ignored);
