...
public class LightWeaponsLightArmorFractionIgnoredAddReward extends PerkReward {
    private float ignored = 0F;

    public LightWeaponsLightArmorFractionIgnoredAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFractionLightArmorIgnored(lightWeaponsProfile.getFractionLightArmorIgnored() + ignored);
