...
public class LightWeaponsLightArmorFractionIgnoredSetReward extends PerkReward {
    private float ignored = 0F;

    public LightWeaponsLightArmorFractionIgnoredSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setFractionLightArmorIgnored(ignored);
