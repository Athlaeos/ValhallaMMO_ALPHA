...
public class LightWeaponsParryCooldownAddReward extends PerkReward {
    private int cooldown = 0;

    public LightWeaponsParryCooldownAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setParryCooldown(lightWeaponsProfile.getParryCooldown() + cooldown);
