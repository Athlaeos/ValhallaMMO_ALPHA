...
public class LightWeaponsParryEnemyDebuffDurationAddReward extends PerkReward {
    private int duration = 0;

    public LightWeaponsParryEnemyDebuffDurationAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setEnemyDebuffDuration(lightWeaponsProfile.getEnemyDebuffDuration() + duration);
