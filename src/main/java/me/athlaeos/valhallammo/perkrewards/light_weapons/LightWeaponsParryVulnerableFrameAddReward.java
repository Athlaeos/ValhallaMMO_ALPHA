...
public class LightWeaponsParryVulnerableFrameAddReward extends PerkReward {
    private int timeFrame = 0;

    public LightWeaponsParryVulnerableFrameAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setParryVulnerableFrame(lightWeaponsProfile.getParryVulnerableFrame() + timeFrame);
