...
public class LightWeaponsRareDropsMultiplierAddReward extends PerkReward {
    private float multiplier = 0F;

    public LightWeaponsRareDropsMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setRareDropMultiplier(lightWeaponsProfile.getRareDropMultiplier() + multiplier);
