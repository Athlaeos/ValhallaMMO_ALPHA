...
public class LightWeaponsRareDropsMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public LightWeaponsRareDropsMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setRareDropMultiplier(multiplier);
