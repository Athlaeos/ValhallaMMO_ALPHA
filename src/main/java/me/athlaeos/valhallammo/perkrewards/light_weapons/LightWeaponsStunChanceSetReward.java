...
public class LightWeaponsStunChanceSetReward extends PerkReward {
    private float chance = 0F;

    public LightWeaponsStunChanceSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setStunChance(chance);
