...
public class LightWeaponsStunDurationSetReward extends PerkReward {
    private int duration = 0;

    public LightWeaponsStunDurationSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof LightWeaponsProfile){
            ...
            lightWeaponsProfile.setStunDuration(duration);
