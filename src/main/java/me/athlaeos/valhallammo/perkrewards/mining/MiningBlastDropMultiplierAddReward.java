...
public class MiningBlastDropMultiplierAddReward extends PerkReward {
    private float exp = 0F;

    public MiningBlastDropMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setBlastMiningDropMultiplier(miningProfile.getBlastMiningDropMultiplier() + exp);
