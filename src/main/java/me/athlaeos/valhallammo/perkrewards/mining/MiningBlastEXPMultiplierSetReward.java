...
public class MiningBlastEXPMultiplierSetReward extends PerkReward {
    private double multiplier = 0D;

    public MiningBlastEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setBlastMiningExpMultiplier(multiplier);
