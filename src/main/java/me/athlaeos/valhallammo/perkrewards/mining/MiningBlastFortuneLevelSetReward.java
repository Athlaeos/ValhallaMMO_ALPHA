...
public class MiningBlastFortuneLevelSetReward extends PerkReward {
    private int level = 0;

    public MiningBlastFortuneLevelSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setExplosionFortuneLevel(level);
