...
public class MiningBlastRadiusMultiplierAddReward extends PerkReward {
    private float exp = 0F;

    public MiningBlastRadiusMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setBlastRadiusMultiplier(miningProfile.getBlastRadiusMultiplier() + exp);
