...
public class MiningBlastRareDropMultiplierSetReward extends PerkReward {
    private float multiplier = 0F;

    public MiningBlastRareDropMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setBlastMiningRareDropRateMultiplier(multiplier);
