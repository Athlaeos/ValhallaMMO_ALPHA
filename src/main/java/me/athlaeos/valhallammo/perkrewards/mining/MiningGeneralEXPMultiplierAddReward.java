...
public class MiningGeneralEXPMultiplierAddReward extends PerkReward {
    private double multiplier = 0D;

    public MiningGeneralEXPMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setGeneralExpMultiplier(miningProfile.getGeneralExpMultiplier() + multiplier);
