...
public class MiningBlastEXPMultiplierAddReward extends PerkReward {
    private double multiplier = 0D;

    public MiningBlastEXPMultiplierAddReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            farmingProfile.setBlastMiningExpMultiplier(farmingProfile.getBlastMiningExpMultiplier() + multiplier);
