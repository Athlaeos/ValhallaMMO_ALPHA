...
public class MiningMiningEXPMultiplierSetReward extends PerkReward {
    private double multiplier = 0D;

    public MiningMiningEXPMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setMiningExpMultiplier(multiplier);
