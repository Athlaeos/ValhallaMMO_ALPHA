...
public class MiningOreExperienceMultiplierSetReward extends PerkReward {
    private float exp = 0F;

    public MiningOreExperienceMultiplierSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setOreExperienceMultiplier(exp);
