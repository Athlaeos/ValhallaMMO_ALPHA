...
public class MiningQuickMineCooldownSetReward extends PerkReward {
    private int cooldown = 0;

    public MiningQuickMineCooldownSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setQuickMineCooldown(cooldown);
