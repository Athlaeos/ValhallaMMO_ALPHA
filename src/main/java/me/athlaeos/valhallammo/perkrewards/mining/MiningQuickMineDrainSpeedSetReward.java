...
public class MiningQuickMineDrainSpeedSetReward extends PerkReward {
    private int speed = 0;

    public MiningQuickMineDrainSpeedSetReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setQuickMineHungerDrainSpeed(speed);
