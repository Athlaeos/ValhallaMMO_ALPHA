...
public class MiningUnbreakableBlocksClearReward extends PerkReward {
    public MiningUnbreakableBlocksClearReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setUnbreakableBlocks(new HashSet<>());
