...
public class MiningVeinMineBlocksClearReward extends PerkReward {
    public MiningVeinMineBlocksClearReward(String name, Object argument) {
        super(name, argument);
    }
    ...
    public void execute(Player player) {
        ...
        if (profile instanceof MiningProfile){
            ...
            miningProfile.setValidVeinMinerBlocks(new HashSet<>());
