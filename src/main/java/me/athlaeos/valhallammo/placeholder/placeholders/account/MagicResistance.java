...
public class MagicResistance extends Placeholder {
    public MagicResistance(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof AccountProfile){
                float resistanceBonus = ((AccountProfile) profile).getMagicResistance();
