...
public class ProjectileResistance extends Placeholder {
    public ProjectileResistance(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof AccountProfile){
                float resistanceBonus = ((AccountProfile) profile).getProjectileResistance();
