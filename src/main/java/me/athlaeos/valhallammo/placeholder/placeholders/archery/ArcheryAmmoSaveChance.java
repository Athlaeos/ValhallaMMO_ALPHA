...
public class ArcheryAmmoSaveChance extends Placeholder {
    public ArcheryAmmoSaveChance(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof ArcheryProfile){
                float chance = ((ArcheryProfile) profile).getAmmoSaveChance();
