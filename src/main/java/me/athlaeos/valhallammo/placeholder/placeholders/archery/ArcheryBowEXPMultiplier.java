...
public class ArcheryBowEXPMultiplier extends Placeholder {
    public ArcheryBowEXPMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof ArcheryProfile){
                double multiplier = ((ArcheryProfile) profile).getBowExpMultiplier();
