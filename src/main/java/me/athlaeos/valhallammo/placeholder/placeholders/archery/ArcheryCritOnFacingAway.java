...
public class ArcheryCritOnFacingAway extends Placeholder {
    private final String unlocked;
    private final String locked;

    public ArcheryCritOnFacingAway(String placeholder) {
        super(placeholder);
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof ArcheryProfile){
                boolean critOnFacingAway = ((ArcheryProfile) profile).isCritOnFacingAway();
                if (critOnFacingAway){
