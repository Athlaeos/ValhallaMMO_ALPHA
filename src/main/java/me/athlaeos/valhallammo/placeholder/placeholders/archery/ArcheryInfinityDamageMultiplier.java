...
public class ArcheryInfinityDamageMultiplier extends Placeholder {
    public ArcheryInfinityDamageMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof ArcheryProfile){
                float multiplier = ((ArcheryProfile) profile).getInfinityDamageMultiplier();
