...
public class FarmingAnimalDropMultiplier extends Placeholder {
    public FarmingAnimalDropMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof FarmingProfile){
                float multiplier = ((FarmingProfile) profile).getAnimalDropMultiplier();
