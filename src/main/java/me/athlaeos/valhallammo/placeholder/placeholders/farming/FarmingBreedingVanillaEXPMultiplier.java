...
public class FarmingBreedingVanillaEXPMultiplier extends Placeholder {
    public FarmingBreedingVanillaEXPMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof FarmingProfile){
                float multiplier = ((FarmingProfile) profile).getBreedingVanillaExpMultiplier();
