...
public class FarmingFishingVanillaEXPMultiplier extends Placeholder {
    public FarmingFishingVanillaEXPMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof FarmingProfile){
                float multiplier = ((FarmingProfile) profile).getFishingVanillaExpMultiplier();
