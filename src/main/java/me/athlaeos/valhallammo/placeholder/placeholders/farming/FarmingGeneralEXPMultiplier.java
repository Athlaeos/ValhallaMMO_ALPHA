...
public class FarmingGeneralEXPMultiplier extends Placeholder {
    public FarmingGeneralEXPMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof FarmingProfile){
                double multiplier = ((FarmingProfile) profile).getGeneralExpMultiplier();
