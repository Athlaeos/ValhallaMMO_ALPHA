...
public class HeavyArmorArmorMultiplier extends Placeholder {
    public HeavyArmorArmorMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyArmorProfile){
                float penalty = ((HeavyArmorProfile) profile).getHeavyArmorMultiplier();
