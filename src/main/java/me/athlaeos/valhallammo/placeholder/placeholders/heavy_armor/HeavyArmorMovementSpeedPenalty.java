...
public class HeavyArmorMovementSpeedPenalty extends Placeholder {
    public HeavyArmorMovementSpeedPenalty(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyArmorProfile){
                float penalty = ((HeavyArmorProfile) profile).getMovementSpeedPenalty();
