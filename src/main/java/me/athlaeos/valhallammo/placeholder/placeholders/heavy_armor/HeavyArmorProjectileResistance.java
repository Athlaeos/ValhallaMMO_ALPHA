...
public class HeavyArmorProjectileResistance extends Placeholder {
    public HeavyArmorProjectileResistance(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyArmorProfile){
                float resistance = ((HeavyArmorProfile) profile).getProjectileDamageResistance();
