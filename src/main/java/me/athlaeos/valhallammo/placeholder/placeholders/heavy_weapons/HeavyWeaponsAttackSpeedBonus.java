...
public class HeavyWeaponsAttackSpeedBonus extends Placeholder {
    public HeavyWeaponsAttackSpeedBonus(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                float bonus = ((HeavyWeaponsProfile) profile).getAttackSpeedBonus();
