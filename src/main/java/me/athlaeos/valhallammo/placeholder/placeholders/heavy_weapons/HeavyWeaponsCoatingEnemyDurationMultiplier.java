...
public class HeavyWeaponsCoatingEnemyDurationMultiplier extends Placeholder {
    public HeavyWeaponsCoatingEnemyDurationMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                float multiplier = ((HeavyWeaponsProfile) profile).getEnemyPotionDurationMultiplier();
