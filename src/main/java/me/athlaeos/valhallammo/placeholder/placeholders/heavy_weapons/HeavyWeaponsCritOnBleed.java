...
public class HeavyWeaponsCritOnBleed extends Placeholder {
    private final String unlocked;
    private final String locked;

    public HeavyWeaponsCritOnBleed(String placeholder) {
        super(placeholder);
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                boolean enabled = ((HeavyWeaponsProfile) profile).isCritOnBleed();
                if (enabled){
