...
public class HeavyWeaponsCrushingBlowCooldown extends Placeholder {
    public HeavyWeaponsCrushingBlowCooldown(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                int frame = ((HeavyWeaponsProfile) profile).getCrushingBlowCooldown();
                if (frame == -1){
