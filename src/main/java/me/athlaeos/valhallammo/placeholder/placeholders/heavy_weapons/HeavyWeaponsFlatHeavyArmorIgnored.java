...
public class HeavyWeaponsFlatHeavyArmorIgnored extends Placeholder {
    public HeavyWeaponsFlatHeavyArmorIgnored(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                float ignored = ((HeavyWeaponsProfile) profile).getFlatHeavyArmorIgnored();
