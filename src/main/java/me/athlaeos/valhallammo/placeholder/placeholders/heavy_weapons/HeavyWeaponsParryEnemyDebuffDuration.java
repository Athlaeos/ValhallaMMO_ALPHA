...
public class HeavyWeaponsParryEnemyDebuffDuration extends Placeholder {
    public HeavyWeaponsParryEnemyDebuffDuration(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                int frame = ((HeavyWeaponsProfile) profile).getEnemyDebuffDuration();
                if (frame == -1){
