...
public class HeavyWeaponsParryTimeFrame extends Placeholder {
    public HeavyWeaponsParryTimeFrame(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                int frame = ((HeavyWeaponsProfile) profile).getParryTimeFrame();
                if (frame == -1){
