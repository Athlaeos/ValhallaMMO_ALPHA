...
public class HeavyWeaponsParryVulnerableTimeFrame extends Placeholder {
    public HeavyWeaponsParryVulnerableTimeFrame(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                int frame = ((HeavyWeaponsProfile) profile).getParryVulnerableFrame();
                if (frame == -1){
