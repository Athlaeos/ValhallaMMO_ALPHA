...
public class HeavyWeaponsStunDuration extends Placeholder {
    public HeavyWeaponsStunDuration(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                int frame = ((HeavyWeaponsProfile) profile).getStunDuration();
                if (frame == -1){
