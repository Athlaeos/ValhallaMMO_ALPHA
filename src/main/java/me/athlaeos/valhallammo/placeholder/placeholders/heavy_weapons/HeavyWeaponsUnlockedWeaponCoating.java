...
public class HeavyWeaponsUnlockedWeaponCoating extends Placeholder {
    private final String unlocked;
    private final String locked;

    public HeavyWeaponsUnlockedWeaponCoating(String placeholder) {
        super(placeholder);
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof HeavyWeaponsProfile){
                boolean enabled = ((HeavyWeaponsProfile) profile).isUnlockedWeaponCoating();
                if (enabled){
