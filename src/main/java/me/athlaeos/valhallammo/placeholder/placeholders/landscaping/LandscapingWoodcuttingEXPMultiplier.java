...
public class LandscapingWoodcuttingEXPMultiplier extends Placeholder {
    public LandscapingWoodcuttingEXPMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LandscapingProfile){
                double multiplier = ((LandscapingProfile) profile).getWoodcuttingExpMultiplier();
