...
public class WoodcuttingRareDropMultiplier extends Placeholder {
    public WoodcuttingRareDropMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LandscapingProfile){
                float multiplier = ((LandscapingProfile) profile).getWoodcuttingRareDropRateMultiplier();
