...
public class LightArmorFullSetHungerSaveChance extends Placeholder {
    public LightArmorFullSetHungerSaveChance(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LightArmorProfile){
                float penalty = ((LightArmorProfile) profile).getFullArmorHungerSaveChance();
