...
public class LightWeaponsAttackSpeedBonus extends Placeholder {
    public LightWeaponsAttackSpeedBonus(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LightWeaponsProfile){
                float bonus = ((LightWeaponsProfile) profile).getAttackSpeedBonus();
