...
public class LightWeaponsBleedOnCrit extends Placeholder {
    private final String unlocked;
    private final String locked;

    public LightWeaponsBleedOnCrit(String placeholder) {
        super(placeholder);
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LightWeaponsProfile){
                boolean enabled = ((LightWeaponsProfile) profile).isBleedOnCrit();
                if (enabled){
