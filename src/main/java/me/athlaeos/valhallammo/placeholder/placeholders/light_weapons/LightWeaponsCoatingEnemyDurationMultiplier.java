...
public class LightWeaponsCoatingEnemyDurationMultiplier extends Placeholder {
    public LightWeaponsCoatingEnemyDurationMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LightWeaponsProfile){
                float multiplier = ((LightWeaponsProfile) profile).getEnemyPotionDurationMultiplier();
