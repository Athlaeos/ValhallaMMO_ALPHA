...
public class LightWeaponsCritOnStun extends Placeholder {
    private final String unlocked;
    private final String locked;

    public LightWeaponsCritOnStun(String placeholder) {
        super(placeholder);
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LightWeaponsProfile){
                boolean enabled = ((LightWeaponsProfile) profile).isCritOnStun();
                if (enabled){
