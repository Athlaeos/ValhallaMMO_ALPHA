...
public class LightWeaponsParryEnemyDebuffDuration extends Placeholder {
    public LightWeaponsParryEnemyDebuffDuration(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LightWeaponsProfile){
                int frame = ((LightWeaponsProfile) profile).getEnemyDebuffDuration();
                if (frame == -1){
