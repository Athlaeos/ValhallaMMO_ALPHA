...
public class LightWeaponsParryTimeFrame extends Placeholder {
    public LightWeaponsParryTimeFrame(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LightWeaponsProfile){
                int frame = ((LightWeaponsProfile) profile).getParryTimeFrame();
                if (frame == -1){
