...
public class LightWeaponsParryVulnerableTimeFrame extends Placeholder {
    public LightWeaponsParryVulnerableTimeFrame(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof LightWeaponsProfile){
                int frame = ((LightWeaponsProfile) profile).getParryVulnerableFrame();
                if (frame == -1){
