...
public class BlastMiningDropMultiplier extends Placeholder {
    public BlastMiningDropMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof MiningProfile){
                float multiplier = ((MiningProfile) profile).getBlastMiningDropMultiplier();
