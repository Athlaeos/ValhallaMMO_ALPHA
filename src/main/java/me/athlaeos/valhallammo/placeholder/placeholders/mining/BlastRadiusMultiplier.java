...
public class BlastRadiusMultiplier extends Placeholder {
    public BlastRadiusMultiplier(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof MiningProfile){
                float multiplier = ((MiningProfile) profile).getBlastRadiusMultiplier();
