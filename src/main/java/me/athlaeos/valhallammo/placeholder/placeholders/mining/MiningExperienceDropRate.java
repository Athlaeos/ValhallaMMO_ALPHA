...
public class MiningExperienceDropRate extends Placeholder {
    public MiningExperienceDropRate(String placeholder) {
        super(placeholder);
    }
    ...
    public String parse(String s, Player p) {
        ...
        if (profile != null){
            if (profile instanceof MiningProfile){
                float multiplier = ((MiningProfile) profile).getBlockMineExperienceRate();
