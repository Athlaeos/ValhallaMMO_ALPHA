...
public class EnchantingProfileMaxCustomAllowedSource extends AccumulativeStatSource {
    public EnchantingProfileMaxCustomAllowedSource(){
    }
    ...
    public double add(Entity p, boolean use) {
        if (p instanceof Player){
            ...
            return enchantingProfile.getMaxCustomEnchantmentsAllowed();
        }
        return 0;
    }
}
