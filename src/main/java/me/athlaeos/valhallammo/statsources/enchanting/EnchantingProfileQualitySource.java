...
public class EnchantingProfileQualitySource extends AccumulativeStatSource {
    private final EnchantmentType enchantmentType;

    public EnchantingProfileQualitySource(EnchantmentType potionType){
    ...
    public double add(Entity p, boolean use) {
        if (p instanceof Player){
            ...
            return enchantingProfile.getEnchantingSkill(enchantmentType);
        }
        return 0;
    }
}
