...
public class EnchantmentSkillExpGainSource extends AccumulativeStatSource {
    @Override
    public double add(Entity p, boolean use) {
        if (p instanceof LivingEntity){
            ...
            for (ItemStack i : equipment){
                EnchantmentWrapper enchantment = CustomEnchantmentManager.getInstance().getCustomEnchant(i, "EXP_GAIN_SKILL");
                if (enchantment != null){
