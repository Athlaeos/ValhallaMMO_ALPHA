...
public class HeavyWeaponsProfileFractionArmorIgnoredSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (offender instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof HeavyWeaponsProfile){
                    return ((HeavyWeaponsProfile) profile).getFractionArmorIgnored();
                }
            }
        }
        return 0;
