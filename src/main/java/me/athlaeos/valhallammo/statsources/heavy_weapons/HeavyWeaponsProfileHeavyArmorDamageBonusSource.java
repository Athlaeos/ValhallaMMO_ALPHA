...
public class HeavyWeaponsProfileHeavyArmorDamageBonusSource extends EvEAccumulativeStatSource {
        ...
        if (p instanceof LivingEntity && e instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof HeavyWeaponsProfile){
                    return ((HeavyWeaponsProfile) profile).getDamageBonusHeavyArmor() * armorCount;
                }
            }
        }
        return 0;
