...
public class HeavyWeaponsProfileImmunityFrameReductionSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (offender instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof HeavyWeaponsProfile){
                    return -((HeavyWeaponsProfile) profile).getImmunityFrameReduction();
                }
            }
        }
        return 0;
