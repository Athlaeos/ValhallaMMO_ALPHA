...
public class LandscapingProfileDiggingRareDropChanceMultiplierSource extends AccumulativeStatSource {
    ...
    public double add(Entity p, boolean use) {
        if (p instanceof Player){
            ...
            return landscapingProfile.getDiggingRareDropRateMultiplier();
        }
        return 0;
    }
}
