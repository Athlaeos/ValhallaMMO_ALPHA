...
public class LandscapingProfileWoodcuttingRareDropChanceMultiplierSource extends AccumulativeStatSource {
    ...
    public double add(Entity p, boolean use) {
        if (p instanceof Player){
            ...
            return landscapingProfile.getWoodcuttingRareDropRateMultiplier();
        }
        return 0;
    }
}
