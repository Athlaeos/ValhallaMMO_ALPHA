...
public class LightWeaponsProfileFractionHeavyArmorIgnoredSource extends EvEAccumulativeStatSource {
    @Override
        ...
        if (offender instanceof Player){
            ...
            if (profile != null){
                if (profile instanceof LightWeaponsProfile){
                    return ((LightWeaponsProfile) profile).getFractionHeavyArmorIgnored();
                }
            }
        }
        return 0;
