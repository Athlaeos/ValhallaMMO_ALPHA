...
//        if (!(packet instanceof ServerboundPlayerActionPacket)) return null;
//        ServerboundPlayerActionPacket packetDig = (ServerboundPlayerActionPacket) packet;
//        BlockPos pos = packetDig.getPos();
//        org.bukkit.block.Block b = p.getWorld().getBlockAt(pos.getX(), pos.getY(), pos.getZ());
//        System.out.println("mining packet on " + pos.getX() + ", " + pos.getY() + ", " + pos.getZ());
